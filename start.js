...
var test=2;*/
    ...
    function slideShow(speichern){
        ...
        if (speichern==false){
            var w = window.open();
        w.document.open();
        w.document.write("<!DOCTYPE html><html><head>" + header + window.atob(js) + "<script>" + window.atob(saveAs64) + "\n" + window.atob(saveObject64) + "</script><style>" +  asciidoctorText +gesamtText+window.atob(revealcss64)+window.atob(serifcss64)  +"</style></head><body><div class='reveal'><div class='slides'>" + code + "</div></div><script>"+window.atob(revealjs64)+"</script><script>Reveal.initialize();</script></body></html>");
        } else {
        //w.document.close();
