...
function zeigeHashTags(hash){
    ...
    */
    ...
    var hash64="";
    ...
    top();
    var VERSION="1.0 2017_08_03 12:22";
...
var test=2;*/
    ...
    function slideShow(speichern){
        ...
        if (speichern==false){
            var w = window.open();
        w.document.open();
        w.document.write("<!DOCTYPE html><html><head>" + header + window.atob(js) + "<script>" + window.atob(saveAs64) + "\n" + window.atob(saveObject64) + "</script><style> "  +gesamtText+asciidoctorText+window.atob(revealcss64)+"\n"+window.atob(serifcss64)  +"\nhtml{font-size:"+schriftgroesse+"px;}\n.reveal{font-size:"+schriftgroesse+"px;}\n</style></head><body><div class='reveal'><div class='slides'>" + code + "</div></div><script>"+window.atob(revealjs64)+"</script><script>Reveal.initialize();</script></body></html>");
        } else {
        //w.document.close();
        //window.open("data:text/html,<!DOCTYPE html><html>"+code+"</html>");
            if (relativerPfad==false){
        var blob = new Blob(["<!DOCTYPE html><html><head>" + header + window.atob(js) + "<script>" + window.atob(saveAs64) + "\n" + window.atob(saveObject64) + "</script><style>"  + gesamtText+ asciidoctorText+window.atob(revealcss64)+window.atob(serifcss64)+ "\nhtml{font-size:"+schriftgroesse+"px;}\n.reveal{font-size:"+schriftgroesse+"px;}\n</style></head><body><div class='reveal'><div class='slides'>" + code + "</div></div><script>"+window.atob(revealjs64)+"</script><script>Reveal.initialize();</script></body></html>"], {
                    type: "text/html;charset=utf-8"
                });
                saveAs(blob, dateiname);
            } else {
                var blob = new Blob(["<!DOCTYPE html><html><head>" + header +"\n"+relPath+ window.atob(js) + "<script>" + window.atob(saveAs64) + "\n" + window.atob(saveObject64) + "</script><style>html{font-size:"+schriftgroesse+"px;}\n.reveal{font-size:"+schriftgroesse+"px;}\n</style></head><body><div class='reveal'><div class='slides'>" + code + "</div></div><script>Reveal.initialize();</script></body></html>"], {
                    type: "text/html;charset=utf-8"
                });
                saveAs(blob, dateiname);
            }
...
*/
        $("#firstMenu").after("<div class='tshareElement toc adoccss'><div><div class='adoccss'>" + html + "</div></div></div>" + knopfJS);
        $(".transparent").remove();
        updateWahl();
    ...
    function setzeFolientyp(){ // passt nach dem Einfügen alle Folientypen an
        $(".tshareElement").each(function(){
           var ft=$(this).attr("ft");
            if (ft==null||ft==""){
                ft="=";
        ...
        fileReader.onload = function (e) {
            ...
            $(container).find(".tshareElement").each(function () {
                ...
                if ($(this).hasClass("zeichenflaeche")) {
                    ...
                    $("#content").append("<div class='toc tshareElement'"+anhang+">" + $(this).html() + "</div>");
                    $("#content").append(knopfJS);
