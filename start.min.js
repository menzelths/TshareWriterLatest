...
var v,f,g,$=this,w=t.type,k=!1,y=function(){m($,"writestart progress write writeend".split(" "))},I=function(){if(f&&s&&"undefined"!=typeof FileReader){var a=new FileReader
return a.onloadend=function(){var e=a.result
f.location.href="data:attachment/file"+e.slice(e.search(/[,;]/)),$.readyState=$.DONE,y()},a.readAsDataURL(t),void($.readyState=$.INIT)}if((k||!v)&&(v=n().createObjectURL(t)),f)f.location.href=v
...
return $.readyState=$.INIT,d||(d="download"),i?(v=n().createObjectURL(t),void setTimeout(function(){a.href=v,a.download=d,r(a),y(),u(v),$.readyState=$.DONE})):(e.chrome&&w&&w!==c&&(g=t.slice||t.webkitSlice,t=g.call(t,0,t.size,c),k=!0),o&&"download"!==d&&(d+=".download"),(w===c||o)&&(f=e),l?(h+=t.size,void l(e.TEMPORARY,h,x(function(e){e.root.getDirectory("saved",C,x(function(e){var n=function(){e.getFile(d,C,x(function(e){e.createWriter(x(function(n){n.onwriteend=function(t){f.location.href=e.toURL(),$.readyState=$.DONE,m($,"writeend",t),u(e)},n.onerror=function(){var e=n.error
...
r.onload=function(e){g=new Image,g.onload=function(){w=0,k=0,y=!0,this.width>this.height&&(y=!1),1==y?(k=Math.min(u,this.height),u>k&&(k=u),w=this.width*k/this.height,w>p&&(k=k*p/w,w=p,y=!1)):(w=Math.min(p,this.width),p>w&&(w=p),k=this.height*w/this.width,k>u&&(w=w*u/k,k=u,y=!0)),$("body").append("<div class='transparent'></div>"),$(".transparent").append("<div class='fenster'><div id='parameter'></div><button id='abbrechenBild'>Abbrechen</button></div>"),0==y?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*w/p)+"'></input><span id='breite'>"+parseInt(100*w/p)+"</span>%, Höhe:<span id='hoehe'>"+parseInt(100*k/u)+"</span>%"):$(".fenster #parameter").html("<br>Höhe (in Prozent von Abschnittshöhe): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*k/u)+"'></input><span id='hoehe'>"+parseInt(100*k/u)+"</span>%, Breite: <span id='breite'>"+parseInt(100*w/p)+"</span>%"),$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksbündig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsbündig</button>"),$(".fenster #parameter").append("<br>y-Position links oben:  <input typ='y' class='parameter' type='range' min='0' max='100' value='0'></input><span id='ypos'>0</span><button class='mittig' typ='oben'>oben bündig</button><button class='mittig' typ='ymitte'>vertikal zentrieren</button><button class='mittig' typ='unten'>unten bündig</button>"),$(".fenster #parameter").append("<br><button id='bildEinfuegen'>Bild einfügen</button>"),QreatorBezier.ladeBild(g,0,0,w,k,!1)},g.src=e.target.result},r.onerror=function(e){console.log(e.target.error.name)},r.onprogress=function(e){console.log(e.loaded,e.total)},r.readAsDataURL(i)}}}}function s(){var e=new Date,t=e.getMonth()+1,n=""
10>t&&(n="0"),n+=t
var a=e.getDate(),i=""
10>a&&(i="0"),i+=a
var r="",s=e.getHours()
...
bearbeitungAn=!1
for(var v="",f="",g="",w=0,k=0,y=!1,I="",x="<select class='sichtbarkeit'>",C=0;10>C;C++)x+=0==C?"<option selected sichtbarkeit='"+C+"'>"+C+"</option> ":"<option sichtbarkeit='"+C+"'>"+C+"</option> "
...
if(null!=e){""==e&&(e="Notiz")
var n=""
f=e
var a=s()
...
var e="",t=0,n=""
...
isNaN(e)&&(e=100*w/p*t/100),isNaN(t)&&(t=100*k/u*e/100)
var n=parseInt($("[typ='x']").val()),a=parseInt($("[typ='y']").val())
...
l==t.r&&d==t.g&&c==t.b&&(n.data[r+3]=0)}i.putImageData(n,0,0),g=new Image,g.onload=function(){w=a.width,k=a.height,y=!0,this.width>this.height&&(y=!1),1==y?(k=Math.min(u,this.height),u>k&&(k=u),w=this.width*k/this.height,w>p&&(k=k*p/w,w=p,y=!1)):(w=Math.min(p,this.width),p>w&&(w=p),k=this.height*w/this.width,k>u&&(w=w*u/k,k=u,y=!0)),console.log(g.src),0==y?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*w/p)+"'></input><span id='breite'>"+parseInt(100*w/p)+"</span>%, Höhe:<span id='hoehe'>"+parseInt(100*k/u)+"</span>%"):$(".fenster #parameter").html("<br>Höhe (in Prozent von Abschnittshöhe): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*k/u)+"'></input><span id='hoehe'>"+parseInt(100*k/u)+"</span>%, Breite: <span id='breite'>"+parseInt(100*w/p)+"</span>%"),$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksbündig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsbündig</button>"),$(".fenster #parameter").append("<br>y-Position links oben:  <input typ='y' class='parameter' type='range' min='0' max='100' value='0'></input><span id='ypos'>0</span><button class='mittig' typ='oben'>oben bündig</button><button class='mittig' typ='ymitte'>vertikal zentrieren</button><button class='mittig' typ='unten'>unten bündig</button>"),$(".fenster #parameter").append("<br><button id='bildEinfuegen'>Bild einfügen</button>"),QreatorBezier.ladeBild(g,0,0,w,k,!1)},g.src=a.toDataURL()}})})):(g=new Image,g.onload=function(){w=0,k=0,y=!0,this.width>this.height&&(y=!1),1==y?(k=Math.min(u,this.height),u>k&&(k=u),w=this.width*k/this.height,w>p&&(k=k*p/w,w=p,y=!1)):(w=Math.min(p,this.width),p>w&&(w=p),k=this.height*w/this.width,k>u&&(w=w*u/k,k=u,y=!0)),0==y?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*w/p)+"'></input><span id='breite'>"+parseInt(100*w/p)+"</span>%, Höhe:<span id='hoehe'>"+parseInt(100*k/u)+"</span>%"):$(".fenster #parameter").html("<br>Höhe (in Prozent von Abschnittshöhe): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*k/u)+"'></input><span id='hoehe'>"+parseInt(100*k/u)+"</span>%, Breite: <span id='breite'>"+parseInt(100*w/p)+"</span>%"),$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksbündig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsbündig</button>"),$(".fenster #parameter").append("<br>y-Position links oben:  <input typ='y' class='parameter' type='range' min='0' max='100' value='0'></input><span id='ypos'>0</span><button class='mittig' typ='oben'>oben bündig</button><button class='mittig' typ='ymitte'>vertikal zentrieren</button><button class='mittig' typ='unten'>unten bündig</button>"),$(".fenster #parameter").append("<br><button id='bildEinfuegen'>Bild einfügen</button>"),QreatorBezier.ladeBild(g,0,0,w,k,!1)},g.src=e.target.result)},n.onerror=function(e){console.log(e.target.error.name)},n.onprogress=function(e){console.log(e.loaded,e.total)},n.readAsDataURL(t)}),$(document).on("click",".loeschen",function(){var e=confirm("Sind Sie sicher, dass die gewählte Zeichenfläche inklusive Inhalt entfernt werden soll? Dieser Schritt kann nicht rückgängig gemacht werden!")
