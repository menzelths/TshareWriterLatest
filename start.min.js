...
x(function(a){a.createWriter(x(function(b){b.onwriteend=function(b){e.location.href=a.toURL();m.readyState=m.DONE;F(m,"writeend",b);J(a)};b.onerror=function(){var a=b.error;a.code!==a.ABORT_ERR&&q()};["writestart","progress","write","abort"].forEach(function(a){b["on"+a]=m["on"+a]});b.write(k);m.abort=function(){b.abort();m.readyState=m.DONE};m.readyState=m.WRITING}),q)}),q)};a.getFile(u,{create:!1},x(function(a){a.remove();b()}),x(function(a){a.code===a.NOT_FOUND_ERR?b():q()}))}),q)}),q)):q()}},
...
$(function(){function a(a){for(var g="",b=0;27>b;b++)$("#bs_"+b).hasClass("aktiv")&&(g+=String.fromCharCode(64+b));$(".markieren").each(function(){$(this).hasClass("aktiv")&&$(this).parent().find(".ebenenAnzeige").each(function(){var p=$(this).attr("aktiv");if("plus"==a)for(var b=0;b<g.length;b++)p.includes(g.charAt(b))||(p+=g.charAt(b));else if("minus"==a){for(var P="",b=0;b<p.length;b++)g.includes(p.charAt(b))||(P+=p.charAt(b));p=P}else"gleich"==a&&(p=g);$(this).attr("aktiv",p);b=G(p);$(this).parent().prev(".tshareElement").attr("sb",
...
parseInt(a)))&&$(this).parent().find(".markieren").removeClass("aktiv")})}function d(){for(var a=Array(27),p=Array(27),b=0;27>b;b++)a[b]=0,p[b]=0;$(".ebenenAnzeige").each(function(){if(!$(this).parent().hasClass("versteckt")){for(var g=$(this).attr("aktiv").toUpperCase(),b=0;b<g.length;b++)p[g.charCodeAt(b)-64]++;if($(this).parent().find(".markieren").hasClass("aktiv"))for(b=0;b<g.length;b++)a[g.charCodeAt(b)-64]++}});return[a,p]}function f(a){var g=!1;a.toUpperCase().startsWith("TAGS_")&&(a=a.split("_")[1],
""==a&&(g=!0),$(".tshareElement").each(function(){var p=$(this).attr("sb");if(null==p||""==p)p="@";for(var b=-1,c=0;c<a.length;c++)p.includes(a.charAt(c))&&(b=c,c=a.length);0<=b||1==g?($(this).attr("style","display:true;"),$(this).next().attr("style","display:true"),$(this).removeClass("versteckt"),$(this).next().removeClass("versteckt"),$(this).next().find(".markieren").removeClass("versteckt")):($(this).attr("style","display:none;"),$(this).next().attr("style","display:none"),$(this).removeClass("versteckt").addClass("versteckt"),
$(this).next().removeClass("versteckt").addClass("versteckt"),$(this).next().find(".markieren").removeClass("versteckt").addClass("versteckt"))}),k(),$("#hideShow").removeClass("komplett").addClass("komplett"))}function h(){$(".tshareElement").each(function(){var a=parseInt($(this).attr("sichtbarkeit"));0==O[a]?$(this).attr("visibility","hidden"):$(this).removeAttr("visibility")})}function k(){for(var a=d(),p=a[0],a=a[1],b=0;27>b;b++)0<a[b]&&p[b]==a[b]?($("[wahl='"+b+"']").removeClass("komplett").addClass("komplett"),
...
v+("<link rel='stylesheet' href='"+t+"/css/style.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/font-awesome.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/katex.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/reveal.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/serif.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/prism.css'>\n")+("<script src='"+t+"/js/reveal.js'>\x3c/script>\n"));t=J();b=b+"_"+t+".html";$(".transparent").remove();var d="",e="",f="",k=0,l=0,q=0,m=0,n=!1,h=0;$(".tshareElement").each(function(){q++;
$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&m++})});0<q&&0==m&&(n=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",g=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";$(this).next().find(".markieren").each(function(){a=$(this).hasClass("aktiv")});var c="=";$(this).next().find(".folientyp").each(function(){c=$(this).val()});"="==c?(f=e="",0==h&&(e="<section>",h=1)):"+"==c?(0==h?e="<section>":
...
var c=$(this).parent().prev().attr("sb");g=$(this).parent().outerHTML();if(null==c||""==c)c="@";var p=$(this).parent().prev().attr("ft");if(null==p||""==p)p="=";c=" sb='"+c+"' ft='"+p+"'";b.hasClass("markdown")?(klasse="markdown adoccss",a+="<div class='tshareElement "+klasse+"'"+c+">"+b.html()+"</div>"+g):b.hasClass("zeichenflaeche")?(klasse="zeichenflaeche zeichenflaecheKlick",a+="<div class='tshareElement "+klasse+"'"+c+">"+b.html()+"</div>"+g):b.hasClass("datei")?(klasse="datei",a+="<div class='tshareElement "+
...
new Clipboard(".kopiereAbschnitt",{text:function(a){m();var b="",g=$(a).parent().prev(),c=$(a).parent().outerHTML(),p=g.attr("sb");if(null==p||""==p)p="@";var d=g.attr("ft");if(null==d||""==d)d="=";p=" sb='"+p+"' ft='"+d+"' ";g.hasClass("markdown")?b="<div class='tshareElement markdown adoccss'"+p+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("zeichenflaeche")?b="<div class='tshareElement zeichenflaeche zeichenflaecheKlick'"+p+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("datei")?
b="<div class='tshareElement datei'"+p+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("toc")?b="<div class='tshareElement toc adoccss'"+p+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("qrcode")&&(b="<div class='tshareElement qrcode adoccss'"+p+">"+$(a).parent().prev().html()+"</div>"+c);M=b;return"JEIF?EJFM?jmEHl\u00a7/87h78\u00a7FHLhl\u00a7F"+b}});E="";for(var a=0;27>a;a++)E+="<button class='wahl allgemein knopfStandard' wahl='"+a+"' >"+String.fromCharCode(64+a)+"</button>";$("#ebenenwahl").html(E);
...
c.onload=function(a){r=new Image;r.onload=function(){l=e=0;w=!0;this.width>this.height&&(w=!1);1==w?(l=Math.min(q,this.height),l<q&&(l=q),e=this.width*l/this.height,e>n&&(l=l*n/e,e=n,w=!1)):(e=Math.min(n,this.width),e<n&&(e=n),l=this.height*e/this.width,l>q&&(e=e*q/l,l=q,w=!0));$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><div id='parameter'></div><button id='abbrechenBild'>Abbrechen</button></div>");0==w?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+
parseInt(100*e/n)+"'></input><span id='breite'>"+parseInt(100*e/n)+"</span>%, H\u00f6he:<span id='hoehe'>"+parseInt(100*l/q)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*l/q)+"'></input><span id='hoehe'>"+parseInt(100*l/q)+"</span>%, Breite: <span id='breite'>"+parseInt(100*e/n)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
...
$("html").html()+"</html>"],{type:"text/html;charset=utf-8"}),saveAs(b,a+"_Editor_"+d+".html");else{var e="",f=0,k=0,h=0,l=0,n=!1;$(".tshareElement").each(function(){h++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&l++})});0<h&&0==l&&(n=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",c=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";$(this).next().find(".markieren").each(function(){a=
...
"</div>\n",f++):$(this).hasClass("qrcode")&&(e+="<div "+b+c+" class='qrcode tshareElement adoccss'>"+$(this).html()+"</div>\n",f++))});var q="",m="";0<f?(q=u(n),m=$("#asciidoctorstyle").text()+$("#prism").text()+$("#fontawesome").text()):0<k&&(m=$("#asciidoctorstyle").text()+$("#prism").text()+$("#fontawesome").text());b=null;0==c?(b=new Blob(["<!DOCTYPE html><html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>\n"+
...
"\x3c/script><style>"+q+m+"</style></head><body>"+e+"</body></html>"],{type:"text/html;charset=utf-8"}),saveAs(b,a+"_"+d+".html")):(b=new Blob(["<!DOCTYPE html><html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>\n"+t+"\n"+window.atob("")+
"<script>"+window.atob("")+
"\x3c/script>\n<script>"+window.atob("")+
"\x3c/script>\n<script>"+window.atob("")+
...
p="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",d=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";$(this).next().find(".markieren").each(function(){g=$(this).hasClass("aktiv")});1==f&&(g=!0);1==g&&($(this).hasClass("zeichenflaeche")?a+="<div "+p+d+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+"</div>\n":$(this).hasClass("markdown")?(a+="<div "+p+d+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n",b++):$(this).hasClass("datei")?
(c++,a+="<div "+p+d+" class='datei tshareElement'>"+$(this).html()+"</div>\n"):$(this).hasClass("toc")?(a+="<div "+p+d+" class='toc tshareElement adoccss'>"+$(this).html()+"</div>\n",b++):$(this).hasClass("qrcode")&&(a+="<div "+p+d+" class='qrcode tshareElement adoccss'>"+$(this).html()+"</div>\n",b++))});var k="",h="";0<b?(k=u(f),h=$("#asciidoctorstyle").text()+$("#prism").text()+$("#fontawesome").text()):0<c&&(h=$("#asciidoctorstyle").text()+$("#prism").text()+$("#fontawesome").text());var l=window.open();
...
break;default:A()}});$(document).on("click","#recalculate",function(){m();nerdamer.flush();nerdamer.clearVars();var a=[];$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'>Bitte warten ...</div>");var b=0,c=0,d=!1;$(".tshareElement").each(function(){b++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&c++})});0<b&&0==c&&(d=!0);$(".markdownText").each(function(){var b=$(this).children(":first").next().text();if(1==d||$(this).parent(".tshareElement").next().find(".markieren").hasClass("aktiv")){$(this).children(":first").attr("id",
"recalculationDiv");b=Textabschnitt.recalculate(b,"#recalculationDiv");if(null!=b&&0<b.length)for(var c=0;c<b.length;c++)a.push(b[c]);$(this).children(":first").removeAttr("id")}});for(var e="\n== Inhaltsverzeichnis\n\n",f=0;f<a.length;f++){for(var e=e+"[none]\n",h=0;h<a[f][0]-1;h++)e+="*";e+=" <<"+a[f][1]+","+a[f][2]+">>\n"}e+="\n\n---";f=Opal.hash2(["header_footer","attributes"],{header_footer:!1,attributes:["icons=font"]});e=Opal.Asciidoctor.$convert(e,f);$(".toc").each(function(){$(this).hasClass("versteckt")||
($(this).next().remove(),$(this).remove())});$("#firstMenu").after("<div class='tshareElement toc adoccss'><div><div class='adoccss'>"+e+"</div></div></div>"+D);$(".transparent").remove();k()});$(document).on("click",".neueZeichenflaeche",function(){m();$(this).parent().after("<div class='zeichenflaeche' id='zeichnung'></div>"+D);x=!0;z="zeichenflaeche";n=998;q=701;QreatorBezier.init("#zeichnung",998,701,"#menu",!0);k()});$(document).on("click",".markieren",function(){m();var a=(new Date).getTime(),
b=$(this).attr("lastClick");$(this).attr("lastClick",a);if(""==b||null==b)b=""+a;b=parseInt(b);if(1E3>a-b&&0==C)$(this).removeClass("aktiv"),$(this).addClass("bereich"),C=!0;else if($(this).hasClass("bereich")&&1==C)C=!1,$(this).removeClass("bereich"),$(this).removeClass("aktiv");else if(1!=C||$(this).hasClass("bereich"))$(this).toggleClass("aktiv");else{var c=-1,d=-1;$(this).addClass("endeBereich");$(this);var e=0;$(".markieren").not(".versteckt").each(function(){$(this).hasClass("endeBereich")?
(d=e,$(this).removeClass("endeBereich")):$(this).hasClass("bereich")&&(c=e);e++});e=0;c<d?$(".markieren").not(".versteckt").each(function(){e>=c&&e<=d&&($(this).removeClass("bereich"),$(this).removeClass("aktiv"),$(this).addClass("aktiv"),C=!1);e++}):c>d&&$(".markieren").not(".versteckt").each(function(){e>=d&&e<=c&&($(this).removeClass("bereich"),$(this).removeClass("aktiv"),C=!1);e++})}k()});$("#markiereAlle").click(function(){m();C=!1;var a=0;$(".tshareElement").not(".versteckt").each(function(){a++});
...
", "+c.getHours()+":"+("0"+c.getMinutes()).substr(-2)+":"+("0"+c.getSeconds()).substr(-2),c="|===\n.3+|icon:file-o[5x]|Dateiname|"+a.name.split(" ").join("_")+"\n|Gr\u00f6\u00dfe in Bytes|"+a.size+"|Einf\u00fcgezeitpunkt|"+c+"\n|===",d=Opal.hash2(["header_footer","attributes"],{header_footer:!1,attributes:["icons=font"]}),c=Opal.Asciidoctor.$convert(c,d);$("#einsetzen").before("<div class='datei tshareElement'><div style='background-color: #f8f8f7'><object style='display:none' id='dataNeu' data='' name="+
...
b=new FileReader;b.onload=function(b){if(a.name.endsWith(".pdf")){var c=function(a){that.seitenZaehler++;var b=a.getViewport(1),b=a.getViewport(2*n/b.width),p=document.createElement("canvas");p.style.display="block";var h=p.getContext("2d");p.height=b.height;p.width=b.width;a=a.render({canvasContext:h,viewport:b});var k=a._internalRenderTask.callback;a._internalRenderTask.callback=function(a){k.call(this,a);this.seitennummer=this.pageNumber;var b=this;a=h.getImageData(0,0,p.width,p.height);for(var c=
0,d=a.data.length;c<d;c+=4){var f=a.data[c+1],m=a.data[c+2];255==a.data[c]&&255==f&&255==m&&(a.data[c+3]=0)}h.putImageData(a,0,0);r=new Image;r.onload=function(){e=p.width;l=p.height;that.zaehler++;QreatorBezier.insertImgAsSVG(this,n,q,"einsetzen"+b.seitennummer,D);console.log("Z\u00e4hler "+that.zaehler+" Seitennummer: "+b.seitennummer);that.zaehler==g&&($(".einsetzen").remove(),$(".transparent").remove())};r.src=p.toDataURL()};d++;null!==f&&d<=g&&f.getPage(d).then(c)};$("#pdfInput").hide();$("#abbrechen").hide().after("<div id='ladeInfo'>Bitte warten ...</div>");
PDFJS.disableWorker=!0;var d=1,g=0,f=null;this.bildLadeZaehler=this.seitenZaehler=this.zaehler=0;that=this;PDFJS.getDocument(b.target.result).then(function(a){f=a;g=a.numPages;for(var b=0;b<g;b++)$("#einsetzen").before("<div class='einsetzen' id='einsetzen"+(b+1)+"'></div>");$("#einsetzen").remove();a.getPage(1).then(c)})}};b.readAsDataURL(a);k()});$(document).on("click",".zeichenflaecheKlick",function(){m();var a=$(this).html();$(this).removeClass("zeichenflaecheKlick");x=!0;z="zeichenflaeche";var b=
parseInt($(this).find("svg").attr("width")),c=parseInt($(this).find("svg").attr("height"));QreatorBezier.init(this,b,c,"#menu",!0);QreatorBezier.loadSVG(a)});$(document).on("click",".markdownText",function(){m();var a=$(this).find(".originaltext").text();$(this).parent().attr("id","markdown");$(this).parent().removeClass("adoccss");x=!0;z="markdown";Textabschnitt.init("#markdown","#menu",a)});$(document).on("change","#fileInput",function(){var a=$("#fileInput")[0].files[0],b=new FileReader;b.onload=
...
function(){QreatorBezier.loescheBild();$(".transparent").remove()});$(document).on("mousemove",".fenster .parameter",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*e/n*b/100));isNaN(b)&&(b=parseInt(100*l/q*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());$(".fenster #breite").html(""+a);$(".fenster #hoehe").html(""+b);$(".fenster #xpos").html(""+c);$(".fenster #ypos").html(""+d)});$(document).on("change",
".fenster .parameter",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*e/n*b/100));isNaN(b)&&(b=parseInt(100*l/q*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());QreatorBezier.ladeBild(r,parseInt(c*n/100),parseInt(d*q/100),parseInt(a*n/100),parseInt(b*q/100),!1)});$(document).on("click","#bildEinfuegen",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&
(a=100*e/n*b/100);isNaN(b)&&(b=100*l/q*a/100);var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());QreatorBezier.ladeBild(r,parseInt(c*n/100),parseInt(d*q/100),parseInt(a*n/100),parseInt(b*q/100),!0);$(".transparent").remove()});$(document).on("click",".mittig",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*e/n*b/100));isNaN(b)&&(b=parseInt(100*l/q*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());
switch($(this).attr("typ")){case "xmitte":c=parseInt(50-a/2);break;case "ymitte":d=parseInt(50-b/2);break;case "links":c=0;break;case "rechts":c=100-a;break;case "oben":d=0;break;case "unten":d=100-b}$(".fenster #xpos").html(""+c);$("[typ='x']").val(c);$(".fenster #ypos").html(""+d);$("[typ='y']").val(d);QreatorBezier.ladeBild(r,parseInt(c*n/100),parseInt(d*q/100),parseInt(a*n/100),parseInt(b*q/100),!1)});$(document).on("change","#imageInput",function(){var a=$("#imageInput")[0].files[0],b=new FileReader;
...
g=a.data.length;b<g;b+=4){var h=a.data[b+1],k=a.data[b+2];255==a.data[b]&&255==h&&255==k&&(a.data[b+3]=0)}d.putImageData(a,0,0);r=new Image;r.onload=function(){e=c.width;l=c.height;w=!0;this.width>this.height&&(w=!1);1==w?(l=Math.min(q,this.height),l<q&&(l=q),e=this.width*l/this.height,e>n&&(l=l*n/e,e=n,w=!1)):(e=Math.min(n,this.width),e<n&&(e=n),l=this.height*e/this.width,l>q&&(e=e*q/l,l=q,w=!0));console.log(r.src);0==w?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+
parseInt(100*e/n)+"'></input><span id='breite'>"+parseInt(100*e/n)+"</span>%, H\u00f6he:<span id='hoehe'>"+parseInt(100*l/q)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*l/q)+"'></input><span id='hoehe'>"+parseInt(100*l/q)+"</span>%, Breite: <span id='breite'>"+parseInt(100*e/n)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
$(".fenster #parameter").append("<br>y-Position links oben:  <input typ='y' class='parameter' type='range' min='0' max='100' value='0'></input><span id='ypos'>0</span><button class='mittig' typ='oben'>oben b\u00fcndig</button><button class='mittig' typ='ymitte'>vertikal zentrieren</button><button class='mittig' typ='unten'>unten b\u00fcndig</button>");$(".fenster #parameter").append("<br><button id='bildEinfuegen'>Bild einf\u00fcgen</button>");QreatorBezier.ladeBild(r,0,0,e,l,!1)};r.src=c.toDataURL()}})})):
(r=new Image,r.onload=function(){l=e=0;w=!0;this.width>this.height&&(w=!1);1==w?(l=Math.min(q,this.height),l<q&&(l=q),e=this.width*l/this.height,e>n&&(l=l*n/e,e=n,w=!1)):(e=Math.min(n,this.width),e<n&&(e=n),l=this.height*e/this.width,l>q&&(e=e*q/l,l=q,w=!0));0==w?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*e/n)+"'></input><span id='breite'>"+parseInt(100*e/n)+"</span>%, H\u00f6he:<span id='hoehe'>"+
parseInt(100*l/q)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*l/q)+"'></input><span id='hoehe'>"+parseInt(100*l/q)+"</span>%, Breite: <span id='breite'>"+parseInt(100*e/n)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
