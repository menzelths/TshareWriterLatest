var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,c,b){a instanceof String&&(a=String(a));for(var d=a.length,m=0;m<d;m++){var h=a[m];if(c.call(b,h,m,a))return{i:m,v:h}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,c,b){a!=Array.prototype&&a!=Object.prototype&&(a[c]=b.value)};
$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(a,c,b,d){if(c){b=$jscomp.global;a=a.split(".");for(d=0;d<a.length-1;d++){var m=a[d];m in b||(b[m]={});b=b[m]}a=a[a.length-1];d=b[a];c=c(d);c!=d&&null!=c&&$jscomp.defineProperty(b,a,{configurable:!0,writable:!0,value:c})}};
...
b("seal");var m=0,h=function(a){this.id_=(m+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};h.prototype.set=function(a,b){c(a);if(!$jscomp.owns(a,d))throw Error("WeakMap key fail: "+a);a[d][this.id_]=b;return this};h.prototype.get=function(a){return $jscomp.owns(a,d)?a[d][this.id_]:void 0};h.prototype.has=function(a){return $jscomp.owns(a,d)&&$jscomp.owns(a[d],this.id_)};h.prototype.delete=
...
function(a){a=d(this,a);return a.entry&&a.list?(a.list.splice(a.index,1),a.list.length||delete this.data_[a.id],a.entry.previous.next=a.entry.next,a.entry.next.previous=a.entry.previous,a.entry.head=null,this.size--,!0):!1};b.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=h();this.size=0};b.prototype.has=function(a){return!!d(this,a).entry};b.prototype.get=function(a){return(a=d(this,a).entry)&&a.value};b.prototype.entries=function(){return m(this,function(a){return[a.key,
a.value]})};b.prototype.keys=function(){return m(this,function(a){return a.key})};b.prototype.values=function(){return m(this,function(a){return a.value})};b.prototype.forEach=function(a,b){for(var c=this.entries(),d;!(d=c.next()).done;)d=d.value,a.call(b,d[1],d[0],this)};b.prototype[Symbol.iterator]=b.prototype.entries;var d=function(a,b){var d=b&&typeof b;"object"==d||"function"==d?c.has(b)?d=c.get(b):(d=""+ ++l,c.set(b,d)):d="p_"+b;var m=a.data_[d];if(m&&$jscomp.owns(a.data_,d))for(a=0;a<m.length;a++){var h=
m[a];if(b!==b&&h.key!==h.key||b===h.key)return{id:d,list:m,index:a,entry:h}}return{id:d,list:m,index:-1,entry:void 0}},m=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},h=function(){var a={};return a.previous=a.next=a.head=a},l=0;return b},"es6-impl","es3");
...
$jscomp.polyfill("Array.from",function(a){return a?a:function(a,b,d){$jscomp.initSymbolIterator();b=null!=b?b:function(a){return a};var c=[],h=a[Symbol.iterator];if("function"==typeof h)for(a=h.call(a);!(h=a.next()).done;)c.push(b.call(d,h.value));else for(var h=a.length,l=0;l<h;l++)c.push(b.call(d,a[l]));return c}},"es6-impl","es3");
...
a.chrome?c():setTimeout(c,500)},C=function(a,b,c){b=[].concat(b);for(var e=b.length;e--;){var d=a["on"+b[e]];if("function"===typeof d)try{d.call(a,c||a)}catch(w){l(w)}}},I=function(a){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type)?new Blob(["\ufeff",a],{type:a.type}):a},G=function(l,q,u){u||(l=I(l));var e=this;u=l.type;var n=!1,w=function(){C(e,["writestart","progress","write","writeend"])},x=function(){if(D&&d&&"undefined"!==typeof FileReader){var b=
new FileReader;b.onloadend=function(){var a=b.result;D.location.href="data:attachment/file"+a.slice(a.search(/[,;]/));e.readyState=e.DONE;w()};b.readAsDataURL(l);e.readyState=e.INIT}else{if(n||!f)f=(a.URL||a.webkitURL||a).createObjectURL(l);D?D.location.href=f:void 0==a.open(f,"_blank")&&d&&(a.location.href=f);e.readyState=e.DONE;w();H(f)}},t=function(a){return function(){if(e.readyState!==e.DONE)return a.apply(this,arguments)}},k={create:!0,exclusive:!1};e.readyState=e.INIT;q||(q="download");if(b){var f=
(a.URL||a.webkitURL||a).createObjectURL(l);setTimeout(function(){c.href=f;c.download=q;var a=new MouseEvent("click");c.dispatchEvent(a);w();H(f);e.readyState=e.DONE})}else{if(a.chrome&&u&&"application/octet-stream"!==u){var v=l.slice||l.webkitSlice;l=v.call(l,0,l.size,"application/octet-stream");n=!0}m&&"download"!==q&&(q+=".download");if("application/octet-stream"===u||m)var D=a;h?(y+=l.size,h(a.TEMPORARY,y,t(function(a){a.root.getDirectory("saved",k,t(function(a){var b=function(){a.getFile(q,k,
t(function(a){a.createWriter(t(function(b){b.onwriteend=function(g){D.location.href=a.toURL();e.readyState=e.DONE;C(e,"writeend",g);H(a)};b.onerror=function(){var a=b.error;a.code!==a.ABORT_ERR&&x()};["writestart","progress","write","abort"].forEach(function(a){b["on"+a]=e["on"+a]});b.write(l);e.abort=function(){b.abort();e.readyState=e.DONE};e.readyState=e.WRITING}),x)}),x)};a.getFile(q,{create:!1},t(function(a){a.remove();b()}),t(function(a){a.code===a.NOT_FOUND_ERR?b():x()}))}),x)}),x)):x()}},
...
parseInt(a)))&&$(this).parent().find(".markieren").removeClass("aktiv")})}function d(){for(var a=Array(27),b=Array(27),r=0;27>r;r++)a[r]=0,b[r]=0;$(".ebenenAnzeige").each(function(){if(!$(this).parent().hasClass("versteckt")){for(var g=$(this).attr("aktiv").toUpperCase(),p=0;p<g.length;p++)b[g.charCodeAt(p)-64]++;if($(this).parent().find(".markieren").hasClass("aktiv"))for(p=0;p<g.length;p++)a[g.charCodeAt(p)-64]++}});return[a,b]}function m(a){var g=!1;a.toUpperCase().startsWith("TAGS_")&&(a=a.split("_")[1],
...
b="KaTeX_Size1 KaTeX_Size2 KaTeX_Size3 KaTeX_Size4 KaTeX_Size1 KaTeX_Size4 KaTeX_Size1 KaTeX_Size2 KaTeX_Main KaTeX_Main KaTeX_Math KaTeX_Main KaTeX_AMS KaTeX_AMS KaTeX_Caligraphic KaTeX_Fraktur KaTeX_Typewriter KaTeX_Script KaTeX_SansSerif KaTeX_Main".split(" "),c=0;c<g.length;c++){var B=0;$(g[c]).each(function(){var b=!1;$(this).parents(".tshareElement").next().find(".markieren").each(function(){b=$(this).hasClass("aktiv")});1!=b&&1!=a||B++});g[c]=B}for(var e=new Set,c=0;c<g.length;c++)0<g[c]&&
e.add(b[c]);0<e.size&&(e.add("KaTeX_Main"),e.add("KaTeX_Math"));g=Array.from(e);console.log("Schriften: ");for(var e="",d=$("#katexStyle").text().split("/* KateX_Fonts END */"),b=d[0].split("/**/"),c=0;c<g.length;c++)for(var f=g[c],k=0;k<b.length;k++)-1!=b[k].indexOf(f)&&(e+=b[k].trim());return b=e+d[1]}function u(a){var b=$("#dateiname").val();null!=b&&""==b&&(b="Slideshow");var g=H(),b=b+"_"+g+".html";$(".transparent").remove();var c="",e="",d="",f=0,k=0,l=0,m=0,n=!1,h=0;$(".tshareElement").each(function(){l++;
$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&m++})});0<l&&0==m&&(n=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",g=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";$(this).next().find(".markieren").each(function(){a=$(this).hasClass("aktiv")});var p="=";$(this).next().find(".folientyp").each(function(){p=$(this).val()});"="==p?d=e="":"+"==p?(0==h?e="<section>":1==h?e="</section><section>":
2==h&&(e="</section></section><section>"),d="",h=1):"++"==p?(0==h?e="<section><section>":1==h?e="</section><section><section>":2==h&&(e="</section><section>"),h=2,d=""):"/"==p&&(e="<span class='fragment'>",d="</span>");1==n&&(a=!0);1==a&&($(this).hasClass("zeichenflaeche")?c+=e+"<div "+b+g+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+"</div>\n"+d:$(this).hasClass("markdown")?(c+=e+"<div "+b+g+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n"+
d,f++):$(this).hasClass("datei")?(k++,c+=e+"<div "+b+g+" class='datei tshareElement'>"+$(this).html()+"</div>\n"+d):$(this).hasClass("toc")&&(c+=e+"<div "+b+g+" class='toc tshareElement adoccss'>"+$(this).html()+"</div>\n"+d,f++))});1==h?c+="</section>":2==h&&(c+="</section></section>");var q=g="";0<f?(g=G(n),q=$("#asciidoctorstyle").text()):0<k&&(q=$("#asciidoctorstyle").text());0==a?(b=window.open(),b.document.open(),b.document.write("<!DOCTYPE html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>"+
...
window.atob("")+
"</style></head><body><div class='reveal'><div class='slides'>"+c+"</div></div><script>"+window.atob("")+
"\x3c/script><script>Reveal.initialize();\x3c/script></body></html>"],{type:"text/html;charset=utf-8"}),saveAs(a,b))}function K(){var a="";q();$(".markieren").each(function(){if($(this).hasClass("aktiv")){var b=$(this).parent().prev(),g="";b.hasClass("markdown")?g="markdown adoccss":b.hasClass("zeichenflaeche")?g="zeichenflaeche zeichenflaecheKlick":b.hasClass("datei")&&(g="datei");a+="<div class='tshareElement "+g+"'>"+$(this).parent().prev().html()+"</div>"+z}});D=a;return a="JEIF?EJFM?jmEHl\u00a7/87h78\u00a7FHLhl\u00a7F"+
a}function q(){1==bearbeitungAn&&("zeichenflaeche"==w?(QreatorBezier.showSVG("zeichenflaeche"),bearbeitungAn=!1):"markdown"==w&&(Textabschnitt.zeigeMarkdown("#markdownTable"),bearbeitungAn=!1,$("#markdown").addClass("adoccss"),$("#markdown").removeAttr("id")))}y();var L=[1,0,1,1,1,1,1,1,1,1],e=998,n=701;bearbeitungAn=!1;var w="",x="",t="",k=0,f=0,v=!1,D="",E=!1,F="";$(document).on("click",".wahl",function(){q();$(this).hasClass("komplett")?(b($(this).attr("wahl")),$(this).removeClass("komplett")):
...
$(this).parent().prev(".tshareElement").removeClass("versteckt").addClass("versteckt"))}),$(this).addClass("komplett"));l()});$(document).ready(function(){new Clipboard("#kopieren",{text:function(a){return K()}});new Clipboard(".kopiereAbschnitt",{text:function(a){q();var b="",g=$(a).parent().prev();g.hasClass("markdown")?b="<div class='tshareElement markdown adoccss'>"+$(a).parent().prev().html()+"</div>"+J:g.hasClass("zeichenflaeche")?b="<div class='tshareElement zeichenflaeche zeichenflaecheKlick'>"+
...
k>e&&(f=f*e/k,k=e,v=!1)):(k=Math.min(e,this.width),k<e&&(k=e),f=this.height*k/this.width,f>n&&(k=k*n/f,f=n,v=!0));$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><div id='parameter'></div><button id='abbrechenBild'>Abbrechen</button></div>");0==v?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*k/e)+"'></input><span id='breite'>"+
parseInt(100*k/e)+"</span>%, H\u00f6he:<span id='hoehe'>"+parseInt(100*f/n)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*f/n)+"'></input><span id='hoehe'>"+parseInt(100*f/n)+"</span>%, Breite: <span id='breite'>"+parseInt(100*k/e)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
...
var a=I($(this).attr("aktiv"));$(".transparent").append("<div class='fenster'>"+a+"<br><button id='ebeneAlle'>Alle w\u00e4hlen</button><button id='ebeneKeine'>Alle abw\u00e4hlen</button><button id='ebeneInvertiere'>Auswahl invertieren</button><br><button id='ebeneOK'>OK</button><button id='ebeneAbbrechen'>Abbrechen</button></div>")});$(document).on("click",".editPart",function(){var a=$(this).parent().prev();if(a.hasClass("markdown")){q();var b=a.find(".originaltext").text();a.attr("id","markdown");
a.removeClass("adoccss");bearbeitungAn=!0;w="markdown";Textabschnitt.init("#markdown","#menu",b)}else if(a.hasClass("zeichenflaeche")){q();b=a.html();a.removeClass("zeichenflaecheKlick");bearbeitungAn=!0;w="zeichenflaeche";var c=parseInt(a.find("svg").attr("width")),e=parseInt(a.find("svg").attr("height"));QreatorBezier.init(a,c,e,"#menu",!0);QreatorBezier.loadSVG(b)}});$(document).on("click","#speichereDatei",function(){var a=$("#dateiname").val();var b=$("#checkEditor").prop("checked");if(null!=
a){""==a&&(a="Notiz");x=a;var c=H();$(".transparent").remove();if(1==b)b=new Blob(["<!DOCTYPE html>"+$("html").html()+"</html>"],{type:"text/html;charset=utf-8"}),saveAs(b,a+"_Editor_"+c+".html");else{var e="",d=0,f=0,k=0,h=0,l=!1;$(".tshareElement").each(function(){k++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&h++})});0<k&&0==h&&(l=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",c=" ft='"+$(this).next().find(".folientyp :selected").text()+
"' ";$(this).next().find(".markieren").each(function(){a=$(this).hasClass("aktiv")});1==l&&(a=!0);1==a&&($(this).hasClass("zeichenflaeche")?e+="<div "+b+c+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+"</div>\n":$(this).hasClass("markdown")?(e+="<div "+b+c+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n",d++):$(this).hasClass("datei")?(f++,e+="<div "+b+c+" class='datei tshareElement'>"+$(this).html()+"</div>\n"):$(this).hasClass("toc")&&(e+=
"<div "+b+c+" class='toc tshareElement adoccss'>"+$(this).html()+"</div>\n",d++))});var m=b="";0<d?(b=G(l),m=$("#asciidoctorstyle").text()):0<f&&(m=$("#asciidoctorstyle").text());b=new Blob(["<!DOCTYPE html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>"+window.atob("")+
"<script>"+window.atob("")+
"\n"+window.atob("")+
...
"\x3c/script><style>"+b+m+"</style></head><body>"+e+"</body></html>"],{type:"text/html;charset=utf-8"});saveAs(b,a+"_"+c+".html")}}});$(document).on("click","#zeigeSlideshow",function(){u(!1)});$(document).on("click","#speichereSlideshow",function(){u(!0)});$("#druckansicht").click(function(){q();var a="",b=0,c=0,e=0,d=0,f=!1;$(".tshareElement").each(function(){e++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&d++})});0<e&&0==d&&(f=!0);$(".tshareElement").each(function(){var g=
...
break;default:y()}});$(document).on("click","#recalculate",function(){q();nerdamer.flush();nerdamer.clearVars();var a=[];$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'>Bitte warten ...</div>");var b=0,c=0,e=!1;$(".tshareElement").each(function(){b++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&c++})});0<b&&0==c&&(e=!0);$(".markdownText").each(function(){var b=$(this).children(":first").next().text();if(1==e||$(this).parent(".tshareElement").next().find(".markieren").hasClass("aktiv")){$(this).children(":first").attr("id",
"recalculationDiv");b=Textabschnitt.recalculate(b,"#recalculationDiv");if(null!=b&&0<b.length)for(var c=0;c<b.length;c++)a.push(b[c]);$(this).children(":first").removeAttr("id")}});for(var d="\n== Inhaltsverzeichnis\n\n",f=0;f<a.length;f++){for(var d=d+"[none]\n",k=0;k<a[f][0]-1;k++)d+="*";d+=" <<"+a[f][1]+","+a[f][2]+">>\n"}d+="\n\n---";f=Opal.hash2(["header_footer","attributes"],{header_footer:!1,attributes:["icons=font"]});d=Opal.Asciidoctor.$convert(d,f);$("#toc").remove();$("#tocBar").remove();
$("#firstMenu").after("<div class='tshareElement toc adoccss' id='toc'><div><div class='adoccss'>"+d+"</div></div></div>"+z);$(".menuBar").first().attr("id","tocBar");$(".transparent").remove();l()});$(document).on("click",".neueZeichenflaeche",function(){q();$(this).parent().after("<div class='zeichenflaeche' id='zeichnung'></div>"+z);bearbeitungAn=!0;w="zeichenflaeche";e=998;n=701;QreatorBezier.init("#zeichnung",998,701,"#menu",!0);l()});$(document).on("click",".markieren",function(){q();var a=
...
(e=d,$(this).removeClass("endeBereich")):$(this).hasClass("bereich")&&(c=d);d++});d=0;c<e?$(".markieren").not(".versteckt").each(function(){d>=c&&d<=e&&($(this).removeClass("bereich"),$(this).removeClass("aktiv"),$(this).addClass("aktiv"),E=!1);d++}):c>e&&$(".markieren").not(".versteckt").each(function(){d>=e&&d<=c&&($(this).removeClass("bereich"),$(this).removeClass("aktiv"),E=!1);d++})}l()});$("#markiereAlle").click(function(){q();E=!1;var a=0;$(".tshareElement").not(".versteckt").each(function(){a++});
...
(q(),$(".markieren").each(function(){$(this).hasClass("aktiv")&&($(this).parent().prev().remove(),$(this).parent().remove())}))});$(document).on("click",".einfuegenClipboard",function(){$(this).parent().after("<div id='einsetzen'></div>");$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><p>Bitte f\u00fcgen Sie den Inhalt des Clipboards in das Textfeld ein (z. B. per Strg+V) und dr\u00fccken Sie dann den Knopf \"Einf\u00fcgen\"</p><textarea id='clipboardExtern' required='required' ></textArea><button id='clipboardExternEinfuegen'>Einf\u00fcgen in Dokument</button><button id='abbrechen'>Abbrechen</button></div>");
$("#clipboardExtern").focus()});$(document).on("click","#clipboardExternEinfuegen",function(){var a=$("#clipboardExtern").val();a.startsWith("JEIF?EJFM?jmEHl\u00a7/87h78\u00a7FHLhl\u00a7F")?1==confirm("Sind Sie sicher, dass dieser Abschnitt eingef\u00fcgt werden soll? Dieser Schritt kann nicht mehr r\u00fcckg\u00e4ngig gemacht werden!")&&(q(),$("#einsetzen").after(a.substring(30,a.length)),$(".transparent").remove(),$("#einsetzen").remove(),l()):window.alert("Der Inhalt hat das falsche Format. Es k\u00f6nnen nur Inhalte aus Tshare eingef\u00fcgt werden.")});
$(document).on("click",".einfuegen",function(){q();$(this).parent().after(D);l()});$(document).on("click",".markdownEinfuegen",function(){q();$(this).parent().after("<div class='markdown tshareElement' id='markdown'></div>"+J);bearbeitungAn=!0;w="markdown";Textabschnitt.init("#markdown","#menu");l()});$(document).on("click",".changeSeparator",function(){q();var a=0,b=0,b=parseInt($(this).parent().prev(".tshareElement").attr("status"));if(void 0==b||isNaN(b))b=0;a=(b+1)%3;$(this).parent().prev(".datei").find("hr").each(function(){$(this).attr("class",
"");$(this).addClass("style_"+a)});$(this).parent().prev(".tshareElement").removeAttr("status");$(this).parent().prev(".tshareElement").attr("status",a);$(this).removeClass("statusFarbeKnopf_"+b);$(this).addClass("statusFarbeKnopf_"+a)});$(document).on("click",".bildEinfuegen",function(){q();$(this).parent().after("<div id='einsetzen'></div>");$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><input id='bildInput' type='file' required='required' ></input><button id='abbrechen'>Abbrechen</button><div id='parameter'></div></div>");
$("#bildInput").trigger("click")});this.saveObject=function(){for(var a=window.event.srcElement,b=a.previousSibling.getAttribute("data"),c=a.previousSibling.getAttribute("type"),a=a.previousSibling.getAttribute("name"),e=b.indexOf(","),b=atob(b.substring(e+1)),e=[],d=0;d<b.length;d+=512){for(var f=b.slice(d,d+512),k=Array(f.length),h=0;h<f.length;h++)k[h]=f.charCodeAt(h);f=new Uint8Array(k);e.push(f)}c=new Blob(e,{type:c});saveAs(c,a)};$(document).on("change","#bildInput",function(){var a=$("#bildInput")[0].files[0],
...
$("#einsetzen").remove()};b.readAsDataURL(a);l()});$(document).on("click",".downloadFile",function(){var a=$(this).attr("data"),a=Base64Binary.decodeArrayBuffer(a);new Blob([a],{type:$(this).attr("datatype")});saveAs([a],$(this).attr("filename"))});$(document).on("click",".pdf",function(){q();$(this).parent().after("<div id='einsetzen'></div>");$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><input id='pdfInput' type='file' accept='application/pdf' required='required' ></input><button id='abbrechen'>Abbrechen</button><div id='parameter'></div></div>");
$("#pdfInput").trigger("click")});$(document).on("change","#pdfInput",function(){var a=$("#pdfInput")[0].files[0],b=new FileReader;b.onload=function(b){if(a.name.endsWith(".pdf")){var c=function(a){that.seitenZaehler++;var b=a.getViewport(1),b=a.getViewport(2*e/b.width),h=document.createElement("canvas");h.style.display="block";var r=h.getContext("2d");h.height=b.height;h.width=b.width;a=a.render({canvasContext:r,viewport:b});var l=a._internalRenderTask.callback;a._internalRenderTask.callback=function(a){l.call(this,
a);this.seitennummer=this.pageNumber;var b=this;a=r.getImageData(0,0,h.width,h.height);for(var c=0,d=a.data.length;c<d;c+=4){var p=a.data[c+1],m=a.data[c+2];255==a.data[c]&&255==p&&255==m&&(a.data[c+3]=0)}r.putImageData(a,0,0);t=new Image;t.onload=function(){k=h.width;f=h.height;that.zaehler++;QreatorBezier.insertImgAsSVG(this,e,n,"einsetzen"+b.seitennummer,z);console.log("Z\u00e4hler "+that.zaehler+" Seitennummer: "+b.seitennummer);that.zaehler==g&&($(".einsetzen").remove(),$(".transparent").remove())};
t.src=h.toDataURL()};d++;null!==p&&d<=g&&p.getPage(d).then(c)};$("#pdfInput").hide();$("#abbrechen").hide().after("<div id='ladeInfo'>Bitte warten ...</div>");PDFJS.disableWorker=!0;var d=1,g=0,p=null;this.bildLadeZaehler=this.seitenZaehler=this.zaehler=0;that=this;PDFJS.getDocument(b.target.result).then(function(a){p=a;g=a.numPages;for(var b=0;b<g;b++)$("#einsetzen").before("<div class='einsetzen' id='einsetzen"+(b+1)+"'></div>");$("#einsetzen").remove();a.getPage(1).then(c)})}};b.readAsDataURL(a);
l()});$(document).on("click",".zeichenflaecheKlick",function(){q();var a=$(this).html();$(this).removeClass("zeichenflaecheKlick");bearbeitungAn=!0;w="zeichenflaeche";var b=parseInt($(this).find("svg").attr("width")),c=parseInt($(this).find("svg").attr("height"));QreatorBezier.init(this,b,c,"#menu",!0);QreatorBezier.loadSVG(a)});$(document).on("click",".markdownText",function(){q();var a=$(this).find(".originaltext").text();$(this).parent().attr("id","markdown");$(this).parent().removeClass("adoccss");
...
$(document).on("mousemove",".fenster .parameter",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*k/e*b/100));isNaN(b)&&(b=parseInt(100*f/n*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());$(".fenster #breite").html(""+a);$(".fenster #hoehe").html(""+b);$(".fenster #xpos").html(""+c);$(".fenster #ypos").html(""+d)});$(document).on("change",".fenster .parameter",function(){var a=parseInt($("[typ='breite']").val()),
b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*k/e*b/100));isNaN(b)&&(b=parseInt(100*f/n*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());QreatorBezier.ladeBild(t,parseInt(c*e/100),parseInt(d*n/100),parseInt(a*e/100),parseInt(b*n/100),!1)});$(document).on("click","#bildEinfuegen",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=100*k/e*b/100);isNaN(b)&&(b=100*f/n*a/100);var c=parseInt($("[typ='x']").val()),
d=parseInt($("[typ='y']").val());QreatorBezier.ladeBild(t,parseInt(c*e/100),parseInt(d*n/100),parseInt(a*e/100),parseInt(b*n/100),!0);$(".transparent").remove()});$(document).on("click",".mittig",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*k/e*b/100));isNaN(b)&&(b=parseInt(100*f/n*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());switch($(this).attr("typ")){case "xmitte":c=parseInt(50-a/2);break;case "ymitte":d=
parseInt(50-b/2);break;case "links":c=0;break;case "rechts":c=100-a;break;case "oben":d=0;break;case "unten":d=100-b}$(".fenster #xpos").html(""+c);$("[typ='x']").val(c);$(".fenster #ypos").html(""+d);$("[typ='y']").val(d);QreatorBezier.ladeBild(t,parseInt(c*e/100),parseInt(d*n/100),parseInt(a*e/100),parseInt(b*n/100),!1)});$(document).on("change","#imageInput",function(){var a=$("#imageInput")[0].files[0],b=new FileReader;b.onload=function(b){a.name.endsWith(".pdf")?(console.log("PDF"),PDFJS.disableWorker=
!0,console.log(b.target.result),PDFJS.getDocument(b.target.result).then(function(a){a.getPage(1).then(function(a){var b=a.getViewport(2.5),c=document.createElement("canvas"),d=c.getContext("2d");c.height=b.height;c.width=b.width;a=a.render({canvasContext:d,viewport:b});var g=a._internalRenderTask.callback;a._internalRenderTask.callback=function(a){g.call(this,a);a=d.getImageData(0,0,c.width,c.height);for(var b=0,h=a.data.length;b<h;b+=4){var l=a.data[b+1],m=a.data[b+2];255==a.data[b]&&255==l&&255==
m&&(a.data[b+3]=0)}d.putImageData(a,0,0);t=new Image;t.onload=function(){k=c.width;f=c.height;v=!0;this.width>this.height&&(v=!1);1==v?(f=Math.min(n,this.height),f<n&&(f=n),k=this.width*f/this.height,k>e&&(f=f*e/k,k=e,v=!1)):(k=Math.min(e,this.width),k<e&&(k=e),f=this.height*k/this.width,f>n&&(k=k*n/f,f=n,v=!0));console.log(t.src);0==v?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*
k/e)+"'></input><span id='breite'>"+parseInt(100*k/e)+"</span>%, H\u00f6he:<span id='hoehe'>"+parseInt(100*f/n)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*f/n)+"'></input><span id='hoehe'>"+parseInt(100*f/n)+"</span>%, Breite: <span id='breite'>"+parseInt(100*k/e)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
$(".fenster #parameter").append("<br>y-Position links oben:  <input typ='y' class='parameter' type='range' min='0' max='100' value='0'></input><span id='ypos'>0</span><button class='mittig' typ='oben'>oben b\u00fcndig</button><button class='mittig' typ='ymitte'>vertikal zentrieren</button><button class='mittig' typ='unten'>unten b\u00fcndig</button>");$(".fenster #parameter").append("<br><button id='bildEinfuegen'>Bild einf\u00fcgen</button>");QreatorBezier.ladeBild(t,0,0,k,f,!1)};t.src=c.toDataURL()}})})):
(t=new Image,t.onload=function(){f=k=0;v=!0;this.width>this.height&&(v=!1);1==v?(f=Math.min(n,this.height),f<n&&(f=n),k=this.width*f/this.height,k>e&&(f=f*e/k,k=e,v=!1)):(k=Math.min(e,this.width),k<e&&(k=e),f=this.height*k/this.width,f>n&&(k=k*n/f,f=n,v=!0));0==v?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*k/e)+"'></input><span id='breite'>"+parseInt(100*k/e)+"</span>%, H\u00f6he:<span id='hoehe'>"+
...
b.onerror=function(a){console.log(a.target.error.name)};b.onprogress=function(a){console.log(a.loaded,a.total)};b.readAsDataURL(a)});$(document).on("click",".loeschen",function(){1==confirm("Sind Sie sicher, dass die gew\u00e4hlte Zeichenfl\u00e4che inklusive Inhalt entfernt werden soll? Dieser Schritt kann nicht r\u00fcckg\u00e4ngig gemacht werden!")&&(q(),$(this).parent().prev().remove(),$(this).parent().remove(),l())})});
