...
function(a){return $jscomp.owns(a,d)&&$jscomp.owns(a[d],this.id_)?delete a[d][this.id_]:!1};return h},"es6","es3");$jscomp.MapEntry=function(){};
...
f[a];if(b!==b&&h.key!==h.key||b===h.key)return{id:d,list:f,index:a,entry:h}}return{id:d,list:f,index:-1,entry:void 0}},f=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},h=function(){var a={};return a.previous=a.next=a.head=a},k=0;return b},"es6","es3");
...
c.prototype.values=function(){return this.map_.values()};c.prototype.keys=c.prototype.values;c.prototype[Symbol.iterator]=c.prototype.values;c.prototype.forEach=function(a,c){var b=this;this.map_.forEach(function(d){return a.call(c,d,d,b)})};return c},"es6","es3");
$jscomp.polyfill("Array.from",function(a){return a?a:function(a,b,d){$jscomp.initSymbolIterator();b=null!=b?b:function(a){return a};var c=[],h=a[Symbol.iterator];if("function"==typeof h)for(a=h.call(a);!(h=a.next()).done;)c.push(b.call(d,h.value));else{h=a.length;for(var k=0;k<h;k++)c.push(b.call(d,a[k]))}return c}},"es6","es3");
$jscomp.polyfill("String.prototype.endsWith",function(a){return a?a:function(a,b){var c=$jscomp.checkStringArgs(this,a,"endsWith");a+="";void 0===b&&(b=c.length);b=Math.max(0,Math.min(b|0,c.length));for(var f=a.length;0<f&&0<b;)if(c[--b]!=a[--f])return!1;return 0>=f}},"es6","es3");
var saveAs=saveAs||function(a){if("undefined"===typeof navigator||!/MSIE [1-9]\./.test(navigator.userAgent)){var c=a.document.createElementNS("http://www.w3.org/1999/xhtml","a"),b="download"in c,d=/Version\/[\d\.]+.*Safari/.test(navigator.userAgent),f=a.webkitRequestFileSystem,h=a.requestFileSystem||f||a.mozRequestFileSystem,k=function(b){(a.setImmediate||a.setTimeout)(function(){throw b;},0)},B=0,J=function(b){var c=function(){"string"===typeof b?(a.URL||a.webkitURL||a).revokeObjectURL(b):b.remove()};
a.chrome?c():setTimeout(c,500)},G=function(a,b,c){b=[].concat(b);for(var d=b.length;d--;){var f=a["on"+b[d]];if("function"===typeof f)try{f.call(a,c||a)}catch(m){k(m)}}},H=function(a){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type)?new Blob(["\ufeff",a],{type:a.type}):a},K=function(k,u,I){I||(k=H(k));var n=this;I=k.type;var L=!1,m=function(){G(n,["writestart","progress","write","writeend"])},p=function(){if(e&&d&&"undefined"!==typeof FileReader){var b=
new FileReader;b.onloadend=function(){var a=b.result;e.location.href="data:attachment/file"+a.slice(a.search(/[,;]/));n.readyState=n.DONE;m()};b.readAsDataURL(k);n.readyState=n.INIT}else{if(L||!z)z=(a.URL||a.webkitURL||a).createObjectURL(k);e?e.location.href=z:void 0==a.open(z,"_blank")&&d&&(a.location.href=z);n.readyState=n.DONE;m();J(z)}},y=function(a){return function(){if(n.readyState!==n.DONE)return a.apply(this,arguments)}},A={create:!0,exclusive:!1};n.readyState=n.INIT;u||(u="download");if(b){var z=
(a.URL||a.webkitURL||a).createObjectURL(k);setTimeout(function(){c.href=z;c.download=u;var a=new MouseEvent("click");c.dispatchEvent(a);m();J(z);n.readyState=n.DONE})}else{if(a.chrome&&I&&"application/octet-stream"!==I){var r=k.slice||k.webkitSlice;k=r.call(k,0,k.size,"application/octet-stream");L=!0}f&&"download"!==u&&(u+=".download");if("application/octet-stream"===I||f)var e=a;h?(B+=k.size,h(a.TEMPORARY,B,y(function(a){a.root.getDirectory("saved",A,y(function(a){var b=function(){a.getFile(u,A,
y(function(a){a.createWriter(y(function(b){b.onwriteend=function(b){e.location.href=a.toURL();n.readyState=n.DONE;G(n,"writeend",b);J(a)};b.onerror=function(){var a=b.error;a.code!==a.ABORT_ERR&&p()};["writestart","progress","write","abort"].forEach(function(a){b["on"+a]=n["on"+a]});b.write(k);n.abort=function(){b.abort();n.readyState=n.DONE};n.readyState=n.WRITING}),p)}),p)};a.getFile(u,{create:!1},y(function(a){a.remove();b()}),y(function(a){a.code===a.NOT_FOUND_ERR?b():p()}))}),p)}),p)):p()}},
...
$(this).next().removeClass("versteckt").addClass("versteckt"),$(this).next().find(".markieren").removeClass("versteckt").addClass("versteckt"))}),k(),$("#hideShow").removeClass("komplett").addClass("komplett"))}function h(){$(".tshareElement").each(function(){var a=parseInt($(this).attr("sichtbarkeit"));0==O[a]?$(this).attr("visibility","hidden"):$(this).removeAttr("visibility")})}function k(){var a=d(),b=a[0];a=a[1];for(var v=0;27>v;v++)0<a[v]&&b[v]==a[v]?($("[wahl='"+v+"']").removeClass("komplett").addClass("komplett"),
$("[wahl='"+v+"']").attr("style","display:true")):0<a[v]&&b[v]<a[v]?($("[wahl='"+v+"']").removeClass("komplett"),$("[wahl='"+v+"']").attr("style","display:true")):0==a[v]&&($("[wahl='"+v+"']").removeClass("komplett"),$("[wahl='"+v+"']").attr("style","display:none"))}function B(){$("#header").removeClass("menuLeft").removeClass("menuRight").removeClass("menuTop").removeClass("menuBottom");$("#header").addClass("menuTop");$("#content").removeClass("moveLeft").removeClass("moveDown").removeClass("moveUp");
$("#content").addClass("moveDown");$("[position='top']").hide();$("[position='right']").show();$("[position='left']").show();$("[position='bottom']").show();$(".auswahl").removeClass("selectMenu")}function J(){var a=new Date,b=a.getMonth()+1,v="";10>b&&(v="0");v+=b;var c=a.getDate();b="";10>c&&(b="0");b+=c;c="";var t=a.getHours();10>t&&(c="0");c+=t;t="";var w=a.getMinutes();10>w&&(t="0");t+=w;w="";var d=a.getSeconds();10>d&&(w="0");w+=d;return""+(1900+a.getYear())+v+b+"_"+c+t+w}function G(a){$("#einsetzen").html("");
...
g="";for(c=0;c<a.length;c++)g.includes(a.charAt(c))||(g+=a.charAt(c));return"<span class='ebenenAnzeige' aktiv='"+g+"'><img src='"+b.toDataURL()+"'   ></img></span>"}function K(a){for(var b="<div>",g=0;27>g;g++){var c="";a.includes(String.fromCharCode(64+g))&&(c="aktiv");b+="<button id='bs_"+g+"' class='ebenenknopf "+c+"'>"+String.fromCharCode(64+g)+"</button>";0==(g+1)%9&&(b+="<br>")}return b+"</div>"}function u(a){var b="",g=".katex .delimsizing.size1;.katex .delimsizing.size2;.katex .delimsizing.size3;.katex .delimsizing.size4;.katex .delimsizing.mult .delim-size1 > span;.katex .delimsizing.mult .delim-size4 > span;.katex .op-symbol.small-op;.katex .op-symbol.large-op;.katex .mathit;.katex .mathbf;.katex .amsrm;.katex .mathbb;.katex .mathcal;.katex .mathfrak;.katex .mathtt;.katex .mathscr;.katex .mathsf;.katex .mainit".split(";");
b="KaTeX_Size1 KaTeX_Size2 KaTeX_Size3 KaTeX_Size4 KaTeX_Size1 KaTeX_Size4 KaTeX_Size1 KaTeX_Size2 KaTeX_Main KaTeX_Main KaTeX_Math KaTeX_Main KaTeX_AMS KaTeX_AMS KaTeX_Caligraphic KaTeX_Fraktur KaTeX_Typewriter KaTeX_Script KaTeX_SansSerif KaTeX_Main".split(" ");for(var c=0;c<g.length;c++){var t=0;$(g[c]).each(function(){var b=!1;$(this).parents(".tshareElement").next().find(".markieren").each(function(){b=$(this).hasClass("aktiv")});1!=b&&1!=a||t++});g[c]=t}var w=new Set;for(c=0;c<g.length;c++)0<
g[c]&&w.add(b[c]);0<w.size&&(w.add("KaTeX_Main"),w.add("KaTeX_Math"));g=Array.from(w);console.log("Schriften: ");w="";var d=$("#katexStyle").text().split("/* KateX_Fonts END */");b=d[0].split("/**/");for(c=0;c<g.length;c++)for(var e=g[c],f=0;f<b.length;f++)-1!=b[f].indexOf(e)&&(w+=b[f].trim());return b=w+d[1]}function L(a){var b=$("#dateiname").val();null!=b&&""==b&&(b="Slideshow");var g=$("#schriftgroesse").val();$("#pathText");var c=$("#checkPath").prop("checked"),t=$("#pathText").val(),w="";1==
c&&(w=w+("<link rel='stylesheet' href='"+t+"/css/style.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/font-awesome.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/katex.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/reveal.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/serif.css'>\n")+("<link rel='stylesheet' href='"+t+"/css/prism.css'>\n")+("<script src='"+t+"/js/reveal.js'>\x3c/script>\n"));t=J();b=b+"_"+t+".html";$(".transparent").remove();var d="",e="",f="",k=0,l=0,p=0,n=0,m=!1,
h=0;$(".tshareElement").each(function(){p++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&n++})});0<p&&0==n&&(m=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",g=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";$(this).next().find(".markieren").each(function(){a=$(this).hasClass("aktiv")});var c="=";$(this).next().find(".folientyp").each(function(){c=$(this).val()});1==m&&(a=!0);1==a&&("="==
c?(f=e="",0==h&&(e="<section>jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg",h=1)):"+"==c?(0==h?e="<section>jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg":1==h?(d=d.replace("jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg",""),e="</section><section>jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg"):2==h&&(e="</section></section><section>jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg"),f="",h=1):"++"==c?(0==h?e="<section><section>":1==h?(d=d.replace("jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg","<section>"),e="</section><section>"):
2==h&&(e="</section><section>"),h=2,f=""):"/"==c&&(e="<span class='fragment'>",f="</span>"));1==a&&($(this).hasClass("zeichenflaeche")?d+=e+"<div "+b+g+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+"</div>\n"+f:$(this).hasClass("markdown")?(d+=e+"<div "+b+g+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n"+f,k++):$(this).hasClass("datei")?(l++,d+=e+"<div "+b+g+" class='datei tshareElement'>"+$(this).html()+"</div>\n"+f):$(this).hasClass("toc")?
(d+=e+"<div "+b+g+" class='toc tshareElement adoccss'>"+$(this).html()+"</div>\n"+f,k++):$(this).hasClass("qrcode")&&(d+=e+"<div "+b+g+" class='qrcode tshareElement adoccss'>"+$(this).html()+"</div>\n"+f,k++))});1==h?d+="</section>":2==h&&(d+="</section></section>");d=d.replace("jafijf\u00dfjw\u00dfmfw829384u\u00df8wfg","");var r=t="";0<k?(t=u(m),r=r=$("#prism").text()+$("#fontawesome").text()):0<l&&(r=r=$("#prism").text()+$("#fontawesome").text());0==a?(b=window.open(),b.document.open(),b.document.write("<!DOCTYPE html><html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>"+
...
"<script>"+window.atob("")+
"\n"+window.atob("")+
"\x3c/script><style>html{font-size:"+g+"px;}\n.reveal{font-size:"+g+"px;}\n</style></head><body><div class='reveal'><div class='slides'>"+d+"</div></div><script>Reveal.initialize();\x3c/script></body></html>"],{type:"text/html;charset=utf-8"}),saveAs(g,b))}function N(){$(".tshareElement").each(function(){var a=$(this).attr("ft");if(null==a||""==a)a="=";$(this).next().find(".folientyp").val(a)})}function I(){var a="";n();$(".markieren").each(function(b,g){if($(this).hasClass("aktiv")){b=$(this).parent().prev();
...
$(document).on("click","#ebeneZuweisungMinus",function(){a("minus");k();$(".transparent").remove()});$(document).on("click","#ebeneZuweisungGleich",function(){a("gleich");k();$(".transparent").remove()});F="<select class='sichtbarkeit'>";for(var C=0;27>C;C++)F=0==C?F+("<option selected sichtbarkeit='"+C+"'>"+String.fromCharCode(64+C)+"</option> "):F+("<option sichtbarkeit='"+C+"'>"+String.fromCharCode(64+C)+"</option> ");F+="</select>";$(document).on("change",".folientyp",function(a){a.preventDefault();
...
a=parseInt($(this).prop("selectedIndex"));$(this).parent().prev().attr("sichtbarkeit",a);h();k()});C=H("@");var E="<span class='menuBar'><button class='loeschen imageTonne oben'></button><button class='markieren imageSelect oben' lastClick='0'></button><button class='kopiereAbschnitt imageCopy oben'></button><select class='folientyp'><option selected folientyp='0'>=</option><option folientyp='1'>+</option><option folientyp='2'>++</option><option folientyp='3'>/</option></select>"+C+"<button class='einfuegen imageInsertInternal unten'></button><button class='einfuegenClipboard imagePaste unten'></button><button class='neueZeichenflaeche imageJournal unten' ></button><button class='pdf imagePDF unten'></button><button class='markdownEinfuegen imageNew unten'></button><button class='bildEinfuegen imageOpen unten'></button><button class='unten imageQR'></button></span>",
P="<span class='menuBar'><button class='loeschen imageTonne oben'></button><button class='markieren imageSelect oben' lastClick='0'></button><button class='kopiereAbschnitt imageCopy oben'></button><select class='folientyp'><option selected folientyp='0'>=</option><option folientyp='1'>+</option><option folientyp='2'>++</option><option folientyp='3'>/</option></select><button class='imagePen editPart oben'></button>"+C+"<button class='einfuegen imageInsertInternal unten'></button><button class='einfuegenClipboard imagePaste unten'></button><button class='neueZeichenflaeche imageJournal unten' ></button><button class='pdf imagePDF unten'></button><button class='markdownEinfuegen imageNew unten'></button><button class='bildEinfuegen imageOpen unten'></button><button class='unten imageQR'></button></span>";
$(document).on("click","#hideShow",function(){n();$(this).hasClass("komplett")?($(".tshareElement").each(function(){$(this).attr("style","display:true");$(this).removeClass("versteckt")}),$(".menuBar").each(function(){$(this).attr("style","display:true");$(this).removeClass("versteckt");$(this).find(".markieren").removeClass("versteckt")}),$(this).removeClass("komplett"),location.hash=""):($(".markieren").each(function(){$(this).hasClass("aktiv")||($(this).parent().prev(".tshareElement").attr("style",
"display:none"),$(this).parent().attr("style","display:none"),$(this).parent().removeClass("versteckt").addClass("versteckt"),$(this).removeClass("versteckt").addClass("versteckt"),$(this).parent().prev(".tshareElement").removeClass("versteckt").addClass("versteckt"))}),$(this).addClass("komplett"));k()});$(document).ready(function(){jQuery.fn.outerHTML=function(a){return a?this.before(a).remove():jQuery("<p>").append(this.eq(0).clone()).html()};new Clipboard("#kopieren",{text:function(a){return I()}});
new Clipboard(".kopiereAbschnitt",{text:function(a){n();var b="",g=$(a).parent().prev(),c=$(a).parent().outerHTML(),q=g.attr("sb");if(null==q||""==q)q="@";var d=g.attr("ft");if(null==d||""==d)d="=";q=" sb='"+q+"' ft='"+d+"' ";g.hasClass("markdown")?b="<div class='tshareElement markdown adoccss'"+q+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("zeichenflaeche")?b="<div class='tshareElement zeichenflaeche zeichenflaecheKlick'"+q+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("datei")?
b="<div class='tshareElement datei'"+q+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("toc")?b="<div class='tshareElement toc adoccss'"+q+">"+$(a).parent().prev().html()+"</div>"+c:g.hasClass("qrcode")&&(b="<div class='tshareElement qrcode adoccss'"+q+">"+$(a).parent().prev().html()+"</div>"+c);M=b;return"JEIF?EJFM?jmEHl\u00a7/87h78\u00a7FHLhl\u00a7F"+b}});F="";for(var a=0;27>a;a++)F+="<button class='wahl allgemein knopfStandard' wahl='"+a+"' >"+String.fromCharCode(64+a)+"</button>";$("#ebenenwahl").html(F);
$(".tshareElement").each(function(){var a=$(this).attr("ft");if(null==a||""==a)a="=";$(this).next().find(".folientyp").val(a)});k()});window.addEventListener("beforeunload",function(a){return a.returnValue="Eventuelle \u00c4nderungen am Dokument k\u00f6nnten verloren gehen!"});document.addEventListener("paste",function(a){if(1==$("#rahmen").length&&0==$(".transparent").length)if(a=a.clipboardData.items)for(var b=0;b<a.length;b++){var g=a[b];if(g.type.startsWith("image/")){g=g.getAsFile();var c=new FileReader;
c.onload=function(a){r=new Image;r.onload=function(){l=e=0;x=!0;this.width>this.height&&(x=!1);1==x?(l=Math.min(p,this.height),l<p&&(l=p),e=this.width*l/this.height,e>m&&(l=l*m/e,e=m,x=!1)):(e=Math.min(m,this.width),e<m&&(e=m),l=this.height*e/this.width,l>p&&(e=e*p/l,l=p,x=!0));$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><div id='parameter'></div><button id='abbrechenBild'>Abbrechen</button></div>");0==x?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+
parseInt(100*e/m)+"'></input><span id='breite'>"+parseInt(100*e/m)+"</span>%, H\u00f6he:<span id='hoehe'>"+parseInt(100*l/p)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*l/p)+"'></input><span id='hoehe'>"+parseInt(100*l/p)+"</span>%, Breite: <span id='breite'>"+parseInt(100*e/m)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
...
var a=K($(this).attr("aktiv"));$(".transparent").append("<div class='fenster'>"+a+"<br><button id='ebeneAlle'>Alle w\u00e4hlen</button><button id='ebeneKeine'>Alle abw\u00e4hlen</button><button id='ebeneInvertiere'>Auswahl invertieren</button><br><button id='ebeneOK'>OK</button><button id='ebeneAbbrechen'>Abbrechen</button></div>")});$(document).on("click",".editPart",function(){var a=$(this).parent().prev();if(a.hasClass("markdown")){n();var b=a.find(".originaltext").text();a.attr("id","markdown");
a.removeClass("adoccss");y=!0;A="markdown";Textabschnitt.init("#markdown","#menu",b)}else if(a.hasClass("zeichenflaeche")){n();b=a.html();a.removeClass("zeichenflaecheKlick");y=!0;A="zeichenflaeche";var c=parseInt(a.find("svg").attr("width")),d=parseInt(a.find("svg").attr("height"));QreatorBezier.init(a,c,d,"#menu",!0);QreatorBezier.loadSVG(b)}});$(document).on("click","#speichereDatei",function(){var a=$("#dateiname").val(),b=$("#checkEditor").prop("checked"),c=$("#checkPath").prop("checked"),d=
$("#pathText").val(),t="";if(null!=a)if(""==a&&(a="Notiz"),1==c&&(t=t+("<link rel='stylesheet' href='"+d+"/css/style.css'>\n")+("<link rel='stylesheet' href='"+d+"/css/font-awesome.css'>\n")+("<link rel='stylesheet' href='"+d+"/css/katex.css'>\n")+("<link rel='stylesheet' href='"+d+"/css/asciidoctor.menz.css'>\n")+("<link rel='stylesheet' href='"+d+"/css/prism.css'>\n")+("<script src='"+d+"/js/jquery.min.js'>\x3c/script>")),z=a,d=J(),$(".transparent").remove(),1==b)b=new Blob(["<!DOCTYPE html>"+$("html").html()+
"</html>"],{type:"text/html;charset=utf-8"}),saveAs(b,a+"_Editor_"+d+".html");else{var e="",f=0,k=0,h=0,l=0,m=!1;$(".tshareElement").each(function(){h++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&l++})});0<h&&0==l&&(m=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'";$(this).next().find(".ebenenAnzeige").attr("aktiv").includes("@");var c=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";
c+=" style='display:none;'";$(this).next().find(".markieren").each(function(){a=$(this).hasClass("aktiv")});1==m&&(a=!0);1==a&&($(this).hasClass("zeichenflaeche")?e+="<div "+b+c+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+"</div>\n":$(this).hasClass("markdown")?(e+="<div "+b+c+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n",f++):$(this).hasClass("datei")?(k++,e+="<div "+b+c+" class='datei tshareElement'>"+$(this).html()+"</div>\n"):$(this).hasClass("toc")?
(e+="<div "+b+c+" class='toc tshareElement adoccss'>"+$(this).html()+"</div>\n",f++):$(this).hasClass("qrcode")&&(e+="<div "+b+c+" class='qrcode tshareElement adoccss'>"+$(this).html()+"</div>\n",f++))});var p="",n="";0<f?(p=u(m),n=$("#asciidoctorstyle").text()+$("#prism").text()+$("#fontawesome").text()):0<k&&(n=$("#asciidoctorstyle").text()+$("#prism").text()+$("#fontawesome").text());b=null;0==c?(b=new Blob(["<!DOCTYPE html><html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>\n"+
window.atob("")+
"<script>"+window.atob("")+
...
"\x3c/script><style>"+p+n+"</style></head><body>"+e+"</body></html>"],{type:"text/html;charset=utf-8"}),saveAs(b,a+"_"+d+".html")):(b=new Blob(["<!DOCTYPE html><html><head><meta name='description' content='Journal for HTML' ><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>\n"+t+"\n"+window.atob("")+
"<script>"+window.atob("")+
"\x3c/script>\n<script>"+window.atob("")+
"\x3c/script>\n<script>"+window.atob("")+
"\x3c/script>\n</head><body>"+e+"</body></html>"],{type:"text/html;charset=utf-8"}),saveAs(b,a+"_Pfad_"+d+".html"))}});$(document).on("click","#zeigeSlideshow",function(){L(!1)});$(document).on("click","#speichereSlideshow",function(){L(!0)});$("#druckansicht").click(function(){n();var a="",b=0,c=0,d=0,e=0,f=!1;$(".tshareElement").each(function(){d++;$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&e++})});0<d&&0==e&&(f=!0);$(".tshareElement").each(function(){var g=!1,
d=!1,q="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'";$(this).next().find(".ebenenAnzeige").attr("aktiv").includes("@")&&(d=!0);var e=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";e=0==d?e+" style='display:none;'":e+" style='display:true;'";$(this).next().find(".markieren").each(function(){g=$(this).hasClass("aktiv")});1==f&&(g=!0);1==g&&($(this).hasClass("zeichenflaeche")?a+="<div "+q+e+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+
"</div>\n":$(this).hasClass("markdown")?(a+="<div "+q+e+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n",b++):$(this).hasClass("datei")?(c++,a+="<div "+q+e+" class='datei tshareElement'>"+$(this).html()+"</div>\n"):$(this).hasClass("toc")?(a+="<div "+q+e+" class='toc tshareElement adoccss'>"+$(this).html()+"</div>\n",b++):$(this).hasClass("qrcode")&&(a+="<div "+q+e+" class='qrcode tshareElement adoccss'>"+$(this).html()+"</div>\n",b++))});var k="",h="";0<b?(k=u(f),h=$("#asciidoctorstyle").text()+
...
function(){$(".transparent").remove();$("einsetzen").remove()});$(document).on("click","#clipboardExternEinfuegen",function(){var a=$("#clipboardExtern").val();a.startsWith("JEIF?EJFM?jmEHl\u00a7/87h78\u00a7FHLhl\u00a7F")?1==confirm("Sind Sie sicher, dass dieser Abschnitt eingef\u00fcgt werden soll? Dieser Schritt kann nicht mehr r\u00fcckg\u00e4ngig gemacht werden!")&&(n(),$("#einsetzen").after(a.substring(30,a.length)),$(".transparent").remove(),$("#einsetzen").remove(),N(),k()):window.alert("Der Inhalt hat das falsche Format. Es k\u00f6nnen nur Inhalte aus Tshare eingef\u00fcgt werden.")});
$(document).on("click",".einfuegen",function(){n();$(this).parent().after(M);N();k()});$(document).on("click",".markdownEinfuegen",function(){n();$(this).parent().after("<div class='markdown tshareElement' id='markdown'></div>"+P);y=!0;A="markdown";Textabschnitt.init("#markdown","#menu");k()});$(document).on("click",".changeSeparator",function(){n();var a=0,b=0;b=parseInt($(this).parent().prev(".tshareElement").attr("status"));if(void 0==b||isNaN(b))b=0;a=(b+1)%3;$(this).parent().prev(".datei").find("hr").each(function(){$(this).attr("class",
"");$(this).addClass("style_"+a)});$(this).parent().prev(".tshareElement").removeAttr("status");$(this).parent().prev(".tshareElement").attr("status",a);$(this).removeClass("statusFarbeKnopf_"+b);$(this).addClass("statusFarbeKnopf_"+a)});$(document).on("click",".bildEinfuegen",function(){n();$(this).parent().after("<div id='einsetzen'></div>");$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><input id='bildInput' type='file' required='required' ></input><button id='abbrechen'>Abbrechen</button><div id='parameter'></div></div>");
$("#bildInput").trigger("click")});this.saveObject=function(){var a=window.event.srcElement,b=a.previousSibling.getAttribute("data"),c=a.previousSibling.getAttribute("type");a=a.previousSibling.getAttribute("name");var d=b.indexOf(",");b=atob(b.substring(d+1));d=[];for(var e=0;e<b.length;e+=512){for(var f=b.slice(e,e+512),h=Array(f.length),k=0;k<f.length;k++)h[k]=f.charCodeAt(k);f=new Uint8Array(h);d.push(f)}c=new Blob(d,{type:c});saveAs(c,a)};$(document).on("change","#bildInput",function(){var a=
$("#bildInput")[0].files[0],b=new FileReader;b.onload=function(b){$("#bildInput").hide();$("#abbrechen").hide().after("<div id='ladeInfo'>Bitte warten ...</div>");var c=new Date;c=c.getDate()+"."+(c.getMonth()+1)+"."+c.getFullYear()+", "+c.getHours()+":"+("0"+c.getMinutes()).substr(-2)+":"+("0"+c.getSeconds()).substr(-2);c="|===\n.3+|icon:file-o[5x]|Dateiname|"+a.name.split(" ").join("_")+"\n|Gr\u00f6\u00dfe in Bytes|"+a.size+"|Einf\u00fcgezeitpunkt|"+c+"\n|===";var d=Opal.hash2(["header_footer",
"attributes"],{header_footer:!1,attributes:["icons=font"]});c=Opal.Asciidoctor.$convert(c,d);$("#einsetzen").before("<div class='datei tshareElement'><div style='background-color: #f8f8f7'><object style='display:none' id='dataNeu' data='' name="+a.name.split(" ").join("_")+" type='"+a.type+"'></object><button onclick='saveObject()'>"+a.name.split(" ").join("_")+" herunterladen</button><div class='adoccss'>"+c+"</div></div></div>"+E);$("#dataNeu").attr("data",b.target.result);$("#dataNeu").removeAttr("id");
$(".transparent").remove();$("#einsetzen").remove()};b.readAsDataURL(a);k()});$(document).on("click",".downloadFile",function(){var a=$(this).attr("data");a=Base64Binary.decodeArrayBuffer(a);new Blob([a],{type:$(this).attr("datatype")});saveAs([a],$(this).attr("filename"))});$(document).on("click",".pdf",function(){n();$(this).parent().after("<div id='einsetzen'></div>");$("body").append("<div class='transparent'></div>");$(".transparent").append("<div class='fenster'><input id='pdfInput' type='file' accept='application/pdf' required='required' ></input><button id='abbrechen'>Abbrechen</button><div id='parameter'></div></div>");
$("#pdfInput").trigger("click")});$(document).on("change","#pdfInput",function(){var a=$("#pdfInput")[0].files[0],b=new FileReader;b.onload=function(b){if(a.name.endsWith(".pdf")){var c=function(a){that.seitenZaehler++;var b=a.getViewport(1);b=a.getViewport(2*m/b.width);var q=document.createElement("canvas");q.style.display="block";var h=q.getContext("2d");q.height=b.height;q.width=b.width;a=a.render({canvasContext:h,viewport:b});var k=a._internalRenderTask.callback;a._internalRenderTask.callback=
function(a){k.call(this,a);this.seitennummer=this.pageNumber;var b=this;r=new Image;r.onload=function(){e=q.width;l=q.height;that.zaehler++;QreatorBezier.insertImgAsSVG(this,m,p,"einsetzen"+b.seitennummer,E);console.log("Z\u00e4hler "+that.zaehler+" Seitennummer: "+b.seitennummer);that.zaehler==g&&($(".einsetzen").remove(),$(".transparent").remove())};r.src=q.toDataURL()};d++;null!==f&&d<=g&&f.getPage(d).then(c)};$("#pdfInput").hide();$("#abbrechen").hide().after("<div id='ladeInfo'>Bitte warten ...</div>");
PDFJS.disableWorker=!0;var d=1,g=0,f=null;this.bildLadeZaehler=this.seitenZaehler=this.zaehler=0;that=this;PDFJS.getDocument(b.target.result).then(function(a){f=a;g=a.numPages;for(var b=0;b<g;b++)$("#einsetzen").before("<div class='einsetzen' id='einsetzen"+(b+1)+"'></div>");$("#einsetzen").remove();a.getPage(1).then(c)})}};b.readAsDataURL(a);k()});$(document).on("click",".zeichenflaecheKlick",function(){n();var a=$(this).html();$(this).removeClass("zeichenflaecheKlick");y=!0;A="zeichenflaeche";var b=
parseInt($(this).find("svg").attr("width")),c=parseInt($(this).find("svg").attr("height"));QreatorBezier.init(this,b,c,"#menu",!0);QreatorBezier.loadSVG(a)});$(document).on("click",".markdownText",function(){n();var a=$(this).find(".originaltext").text();$(this).parent().attr("id","markdown");$(this).parent().removeClass("adoccss");y=!0;A="markdown";Textabschnitt.init("#markdown","#menu",a)});$(document).on("change","#fileInput",function(){var a=$("#fileInput")[0].files[0],b=new FileReader;b.onload=
function(a){a=a.target.result;O=[1,0,1,1,1,1,1,1,1,1];y=!1;r=z=A="";D=!1;var b=document.createElement("div");b.id="container";b.innerHTML=a;$("#content").html("<span id='firstMenu'><button class='einfuegen imageInsertInternal unten'></button><button class='einfuegenClipboard imagePaste unten'></button><button class='neueZeichenflaeche imageJournal unten' ></button><button class='pdf imagePDF unten'></button><button class='markdownEinfuegen imageNew unten'></button><button class='bildEinfuegen imageOpen unten'></button><button class='unten imageQR'></button></span> </div>");
$(b).find(".tshareElement").each(function(){var a=$(this).attr("sb");if(null==a||""==a)a="@";var b=$(this).attr("ft");if(null==b||""==b)b="=";$(this).attr("tags");var c=" sb='"+a+"' ft='"+b+"' ";$(this).hasClass("zeichenflaeche")?($("#content").append("<div class='zeichenflaeche tshareElement zeichenflaecheKlick'"+c+">"+$(this).html()+"</div>"),$("#content").append(E)):$(this).hasClass("markdown")?($("#content").append("<div class='markdown tshareElement adoccss'"+c+">"+$(this).html()+"</div>"),$("#content").append(P)):
$(this).hasClass("datei")?($("#content").append("<div class='datei tshareElement'"+c+">"+$(this).html()+"</div>"),$("#content").append(E)):$(this).hasClass("toc")?($("#content").append("<div class='toc tshareElement'"+c+">"+$(this).html()+"</div>"),$("#content").append(E)):$(this).hasClass("qrcode")&&($("#content").append("<div class='qrcode tshareElement'"+c+">"+$(this).html()+"</div>"),$("#content").append(E));$(".ebenenAnzeige").last().attr("aktiv",a);$(".folientyp").last().val(b);a=H(a);$(".ebenenAnzeige").last().wrap("<span id='ersetzung'></span>");
...
function(){QreatorBezier.loescheBild();$(".transparent").remove()});$(document).on("mousemove",".fenster .parameter",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*e/m*b/100));isNaN(b)&&(b=parseInt(100*l/p*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());$(".fenster #breite").html(""+a);$(".fenster #hoehe").html(""+b);$(".fenster #xpos").html(""+c);$(".fenster #ypos").html(""+d)});$(document).on("change",
".fenster .parameter",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*e/m*b/100));isNaN(b)&&(b=parseInt(100*l/p*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());QreatorBezier.ladeBild(r,parseInt(c*m/100),parseInt(d*p/100),parseInt(a*m/100),parseInt(b*p/100),!1)});$(document).on("click","#bildEinfuegen",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&
(a=100*e/m*b/100);isNaN(b)&&(b=100*l/p*a/100);var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());QreatorBezier.ladeBild(r,parseInt(c*m/100),parseInt(d*p/100),parseInt(a*m/100),parseInt(b*p/100),!0);$(".transparent").remove()});$(document).on("click",".mittig",function(){var a=parseInt($("[typ='breite']").val()),b=parseInt($("[typ='hoehe']").val());isNaN(a)&&(a=parseInt(100*e/m*b/100));isNaN(b)&&(b=parseInt(100*l/p*a/100));var c=parseInt($("[typ='x']").val()),d=parseInt($("[typ='y']").val());
switch($(this).attr("typ")){case "xmitte":c=parseInt(50-a/2);break;case "ymitte":d=parseInt(50-b/2);break;case "links":c=0;break;case "rechts":c=100-a;break;case "oben":d=0;break;case "unten":d=100-b}$(".fenster #xpos").html(""+c);$("[typ='x']").val(c);$(".fenster #ypos").html(""+d);$("[typ='y']").val(d);QreatorBezier.ladeBild(r,parseInt(c*m/100),parseInt(d*p/100),parseInt(a*m/100),parseInt(b*p/100),!1)});$(document).on("change","#imageInput",function(){var a=$("#imageInput")[0].files[0],b=new FileReader;
...
g=a.data.length;b<g;b+=4){var h=a.data[b+1],k=a.data[b+2];255==a.data[b]&&255==h&&255==k&&(a.data[b+3]=0)}d.putImageData(a,0,0);r=new Image;r.onload=function(){e=c.width;l=c.height;x=!0;this.width>this.height&&(x=!1);1==x?(l=Math.min(p,this.height),l<p&&(l=p),e=this.width*l/this.height,e>m&&(l=l*m/e,e=m,x=!1)):(e=Math.min(m,this.width),e<m&&(e=m),l=this.height*e/this.width,l>p&&(e=e*p/l,l=p,x=!0));console.log(r.src);0==x?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+
parseInt(100*e/m)+"'></input><span id='breite'>"+parseInt(100*e/m)+"</span>%, H\u00f6he:<span id='hoehe'>"+parseInt(100*l/p)+"</span>%"):$(".fenster #parameter").html("<br>H\u00f6he (in Prozent von Abschnittsh\u00f6he): <input typ='hoehe' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*l/p)+"'></input><span id='hoehe'>"+parseInt(100*l/p)+"</span>%, Breite: <span id='breite'>"+parseInt(100*e/m)+"</span>%");$(".fenster #parameter").append("<br>x-Position links oben:  <input typ='x' class='parameter' type='range' min='0' max='100' value='0'></input><span id='xpos'>0</span><button class='mittig' typ='links'>linksb\u00fcndig</button><button class='mittig' typ='xmitte'>horizontal zentrieren</button><button class='mittig' typ='rechts'>rechtsb\u00fcndig</button>");
$(".fenster #parameter").append("<br>y-Position links oben:  <input typ='y' class='parameter' type='range' min='0' max='100' value='0'></input><span id='ypos'>0</span><button class='mittig' typ='oben'>oben b\u00fcndig</button><button class='mittig' typ='ymitte'>vertikal zentrieren</button><button class='mittig' typ='unten'>unten b\u00fcndig</button>");$(".fenster #parameter").append("<br><button id='bildEinfuegen'>Bild einf\u00fcgen</button>");QreatorBezier.ladeBild(r,0,0,e,l,!1)};r.src=c.toDataURL()}})})):
(r=new Image,r.onload=function(){l=e=0;x=!0;this.width>this.height&&(x=!1);1==x?(l=Math.min(p,this.height),l<p&&(l=p),e=this.width*l/this.height,e>m&&(l=l*m/e,e=m,x=!1)):(e=Math.min(m,this.width),e<m&&(e=m),l=this.height*e/this.width,l>p&&(e=e*p/l,l=p,x=!0));0==x?$(".fenster #parameter").html("<br>Breite (in Prozent von Abschnittsbreite): <input typ='breite' class='parameter' type='range' min='0' max='100' value='"+parseInt(100*e/m)+"'></input><span id='breite'>"+parseInt(100*e/m)+"</span>%, H\u00f6he:<span id='hoehe'>"+
...
b.onerror=function(a){console.log(a.target.error.name)};b.onprogress=function(a){console.log(a.loaded,a.total)};b.readAsDataURL(a)});$(document).on("click",".loeschen",function(){1==confirm("Sind Sie sicher, dass die gew\u00e4hlte Zeichenfl\u00e4che inklusive Inhalt entfernt werden soll? Dieser Schritt kann nicht r\u00fcckg\u00e4ngig gemacht werden!")&&(n(),$(this).parent().prev().remove(),$(this).parent().remove(),k())})});
