...
$(this).next().find(".markieren").each(function(){$(this).hasClass("aktiv")&&m++})});0<h&&0==m&&(l=!0);$(".tshareElement").each(function(){var a=!1,b="sb='"+$(this).next().find(".ebenenAnzeige").attr("aktiv")+"'",g=" ft='"+$(this).next().find(".folientyp :selected").text()+"' ";$(this).next().find(".markieren").each(function(){a=$(this).hasClass("aktiv")});var p="=";$(this).next().find(".folientyp").each(function(){p=$(this).val()});"="==p?e=t="":"+"==p?(0==k?t="<section>":1==k?t="</section><section>":
2==k&&(t="</section></section><section>"),e="",k=1):"++"==p?(0==k?t="<section><section>":1==k?t="</section><section><section>":2==k&&(t="</section><section>"),k=2,e=""):"/"==p&&(t="<span class='fragment'>",e="</span>");1==l&&(a=!0);1==a&&($(this).hasClass("zeichenflaeche")?c+=t+"<div "+b+g+" class='zeichenflaeche tshareElement' onClick='nextLayer(this)' >"+$(this).html()+"</div>\n"+e:$(this).hasClass("markdown")?(c+=t+"<div "+b+g+" class='markdown tshareElement adoccss'>"+$(this).html()+"</div>\n"+
