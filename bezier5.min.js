...
[],bilder[a]=[],q[a]=[];ba=!0;ha=!1;ta=0;W=ca=!1;aa=[];$("#farben").spectrum({showPaletteOnly:!0,togglePaletteOnly:!1,hideAfterPaletteSelect:!0,togglePaletteMoreText:"mehr",togglePaletteLessText:"weniger",chooseText:"Ok",cancelText:"Abbrechen",color:"black",palette:["#000 #444 #666 #999 #ccc #eee #f3f3f3 #fff".split(" "),"#f00 #f90 #ff0 #0f0 #0ff #00f #90f #f0f".split(" "),"#f4cccc #fce5cd #fff2cc #d9ead3 #d0e0e3 #cfe2f3 #d9d2e9 #ead1dc".split(" "),"#ea9999 #f9cb9c #ffe599 #b6d7a8 #a2c4c9 #9fc5e8 #b4a7d6 #d5a6bd".split(" "),
"#e06666 #f6b26b #ffd966 #93c47d #76a5af #6fa8dc #8e7cc3 #c27ba0".split(" "),"#c00 #e69138 #f1c232 #6aa84f #45818e #3d85c6 #674ea7 #a64d79".split(" "),"#900 #b45f06 #bf9000 #38761d #134f5c #0b5394 #351c75 #741b47".split(" "),"#600 #783f04 #7f6000 #274e13 #0c343d #073763 #20124d #4c1130".split(" ")]});window.PointerEvent?(N.addEventListener("pointerdown",function(a){r(a)}),N.addEventListener("pointermove",function(a){E(a)}),N.addEventListener("pointerup",function(a){B(a)})):(N.addEventListener("mousedown",
r),N.addEventListener("mousemove",E),N.addEventListener("mouseup",B),N.addEventListener("touchstart",h),N.addEventListener("touchmove",g),N.addEventListener("touchend",n));var p="";$("#ebenenBunt").click(function(){fa=(fa+1)%2;$(".layer").each(function(a){1==fa&&1==I[a]?($(this).attr("style","background-color: "+ka[a]+";"),$("#ebenenBunt").addClass("aktiv")):($(this).removeAttr("style"),$("#ebenenBunt").removeClass("aktiv"))});K(k,0,l.length-1,!0);v()});$("#ebenenAnAus").click(function(){for(var a=
0,b=0;b<l.length;b++)1==I[b]&&a++;if(0<=a&&10>a)for(b=0;b<l.length;b++)I[b]=1;else for(b=0;b<l.length;b++)I[b]=0;K(k,0,l.length-1,!0);v()});$("#zurueck").click(function(a){if(0<O){O--;if(0<=O){ba=!0;a=X[O];for(var b=0;b<a.length;b++)if(3==a[b].length)for(var c=a[b][0],d=a[b][1],f=a[b][2],e=0;e<q[c].length;e++)Math.abs(q[c][e])>=Math.abs(d)&&Math.abs(q[c][e])<=Math.abs(f)&&(q[c][e]=-q[c][e]);else if(2==a[b].length)for(c=a[b][0],d=a[b][1],e=0;e<q[c].length;e++)Math.abs(q[c][e])==Math.abs(d)&&(q[c][e]=
-q[c][e],e=q[c].length)}K(k,0,l.length-1,!0)}});$("#vor").click(function(a){if(1==ba&&O<X.length){ba=!0;a=X[O];for(var b=0;b<a.length;b++)if(3==a[b].length)for(var c=a[b][0],d=a[b][1],f=a[b][2],e=0;e<q[c].length;e++)Math.abs(q[c][e])>=Math.abs(d)&&Math.abs(q[c][e])<=Math.abs(f)&&(q[c][e]=-q[c][e]);else if(2==a[b].length)for(c=a[b][0],d=a[b][1],e=0;e<q[c].length;e++)Math.abs(q[c][e])==Math.abs(d)&&(q[c][e]=-q[c][e],e=q[c].length);O++;K(k,0,l.length-1,!0)}});$("#tbutton").click(function(a){a.preventDefault();
a=$("#svgText").val();Ba.loadSVG(a)});$("#download").click(function(a){a.preventDefault();a=$("html").html();window.open("data:text/csv,"+a)});$("#farben").on("change.spectrum",function(a,b){a.preventDefault();V=b;Z=0;L=ea[pa];$("#stift").focus();v()});$("#dicken").change(function(a){a.preventDefault();a=parseInt($(this).prop("selectedIndex"));0==Z?pa=a:wa=a;L=ea[a];v()});$(".layer").click(function(a){a.preventDefault();a=parseInt($(this).attr("layer"));1==I[a]?k==a?I[a]=0:(k=a,null==w[k]&&(w[k]=
[])):(I[a]=1,k=a,null==w[k]&&(w[k]=[]));K(l[k],0,l.length-1,!0);v()});$(".check").click(function(a){a=0;1==$(this).prop("checked")&&(a=1);I[parseInt($(this).attr("value"))]=a;K(l[k],0,l.length-1,!0);v()});$("#radierer").click(function(a){a.preventDefault();Z=1;L=ea[wa];v()});$("#stift").click(function(){L=ea[pa];Z=0;v()});$("#raster").click(function(a){a.preventDefault();ma=(ma+1)%4;var b=sa[ma][0];a=sa[ma][1];var c=sa[ma][2];w[0]=[];q[0]=[];new t(0,0);new t(0,0);if(0<b.length)for(var d=0;d<G;d+=
b[b.length-1])for(var f=0;f<b.length;f++){var e=new t(d+b[f],0);var g=new t(d+b[f],F);e=[e,z.addiere(e,z.multipliziereMitSkalar(z.subtrahiere(g,e),1/3)),z.addiere(e,z.multipliziereMitSkalar(z.subtrahiere(g,e),2/3)),g];w[0].push([e,z.findeRechtecksHuelle(e),0,2,c]);q[0].push(w[0].length)}if(0<a.length)for(b=0;b<F;b+=a[a.length-1])for(f=0;f<a.length;f++)e=new t(0,b+a[f]),g=new t(G,b+a[f]),e=[e,z.addiere(e,z.multipliziereMitSkalar(z.subtrahiere(g,e),1/3)),z.addiere(e,z.multipliziereMitSkalar(z.subtrahiere(g,
e),2/3)),g],w[0].push([e,z.findeRechtecksHuelle(e),0,2,c]),q[0].push(w[0].length);K(l[k],0,l[k],!0)});$("#loeschenAktiv").click(function(a){a.preventDefault();var b=H.createImageData(G,F);for(a=0;a<b.length;a+=4)b[a]=255,b[a+1]=255,b[a+2]=255,b[a+3]=0;H.putImageData(b,0,0);b=[];for(a=0;a<q[l[k]].length;a++)0<q[l[k]][a]&&(q[l[k]][a]=-q[l[k]][a],b.push([l[k],q[l[k]][a]]));X[O]=b;O++;S();K(k,0,k,!0)});$("#loescheBilder").click(function(){1==confirm("Sind Sie sicher, dass alle Bilder in der aktiven Ebene gel\u00f6scht werden sollen? Dieser Schritt kann nicht r\u00fcckg\u00e4ngig gemacht werden.")&&
(bilder[l[k]]=[],K(k,0,k,!0))});$("#loeschen").click(function(a){a.preventDefault();a=H.createImageData(G,F);for(var b=0;b<a.length;b+=4)a[b]=255,a[b+1]=255,a[b+2]=255,a[b+3]=0;H.putImageData(a,0,0);ra.putImageData(a,0,0);for(b=0;b<l.length;b++)w[l[b]]=[],q[l[b]]=[];X=[]});$("#knopf").click(function(a){a.preventDefault();QreatorBezier.showSVG()});v()};this.loescheBild=function(){for(var a=0;a<l.length;a++)0<bilder[a].length&&!1===bilder[a][bilder[a].length-1].behalten&&bilder[a].pop();K(k,0,k,!0)};
this.ladeBild=function(a,c,e,f,b,d){var h=document.createElement("canvas");h.width=f;h.height=b;h.getContext("2d").drawImage(a,0,0,f,b);a=h.toDataURL();c={img:null,ebene:k,nr:bilder[l[k]].length,data:a,breite:f,hoehe:b,x:c,y:e,behalten:d};for(e=0;e<l.length;e++)0<bilder[e].length&&!1===bilder[e][bilder[e].length-1].behalten&&bilder[e].pop();bilder[l[k]].push(c);K(k,0,k,!0)};this.insertImgAsSVG=function(a,c,e,f,b){$("#content").append("<div id='qreator_svgbild'></div>");$("#qreator_svgbild").html("<svg  width='100%' height='100%' viewBox='0 0 "+
c+" "+c/a.width*a.height+"' hoehegesetzt='"+c/a.width*a.height+"' breitegesetzt='"+c+"' heightoriginal='"+c/a.width*a.height+"' id='qreator_svgbild2' class='qreator_svg'><g fill='none' stroke-linecap='round' id='global'></g>");$("#qreator_svgbild2 #global").append("<g id='layer_2'></g>");$("#qreator_svgbild2 #global #layer_2").append(document.createElementNS("http://www.w3.org/2000/svg","image"));$("#qreator_svgbild2 #global #layer_2 image").last().attr("bildnr","0").attr("x","0").attr("y","0").attr("width",
""+c).attr("height",""+c/a.width*a.height).attr("xlink:href",""+a.src).attr("hoeheoriginal",""+c/a.width*a.height);$("#"+f).before("<div class='zeichenflaeche tshareElement zeichenflaecheKlick' >"+$("#qreator_svgbild").html()+"</div>"+b);$("#qreator_svgbild2").removeAttr("id");$("#qreator_svgbild").html("");$("#qreator_svgbild").remove()};this.showSVG=function(a){var c="",e=0;$("#qreator_svgbild").html("<svg  width='"+G+"' height='"+F+"' id='qreator_svgbild2' class='qreator_svg'><g fill='none' stroke-linecap='round' id='global'></g>");
for(var f=0;f<l.length;f++){var b=l[f];if(null!=w[b]&&0<w[b].length||null!=bilder[b]&&0<bilder[b].length){var d="";0==I[f]&&(d="visibility='hidden'");$("#qreator_svgbild2 #global").append("<g id='layer_"+b+"' "+d+"></g>");if(null!=bilder[b])for(d=0;d<bilder[b].length;d++){var h=bilder[b][d];$("#qreator_svgbild2 #global #layer_"+b).append(document.createElementNS("http://www.w3.org/2000/svg","image"));$("#qreator_svgbild2 #global #layer_"+b+" image").last().attr("bildnr",d).attr("x",""+h.x).attr("y",
""+h.y).attr("width",""+h.breite).attr("height",""+h.hoehe).attr("xlink:href",""+h.data);h.y+h.hoehe>e&&(e=h.y+h.hoehe)}if(null!=w[b]&&0<w[b].length){d="";h=w[b][0][0][3];for(var g="",n="",r="",E="",k=0;k<q[b].length;k++){var p=q[b][k];if(0<p){M=p-1;p=w[b][M][0];var t=w[b][M][4],v=w[b][M][3],z=w[b][M][1][3];z>e&&0<b&&(e=z);if(t!=g||v!=n)r=" stroke='"+t+"'",g=t,r+=" stroke-width='"+v+"'",n=v;0<r.length&&(0<d.length&&(c+="<path d='"+d+"' "+E+" />",h={x:-1,y:-1},d=""),E=r,r="");d=0<M&&p[0].x===h.x&&
p[0].y===h.y?d+(" c "+u(p[1].x-p[0].x,Q)+" "+u(p[1].y-p[0].y,Q)+" "+u(p[2].x-p[0].x,Q)+" "+u(p[2].y-p[0].y,Q)+" "+u(p[3].x-p[0].x,Q)+" "+u(p[3].y-p[0].y,Q)):d+(" M "+u(p[0].x,Q)+" "+u(p[0].y,Q)+" c "+u(p[1].x-p[0].x,Q)+" "+u(p[1].y-p[0].y,Q)+" "+u(p[2].x-p[0].x,Q)+" "+u(p[2].y-p[0].y,Q)+" "+u(p[3].x-p[0].x,Q)+" "+u(p[3].y-p[0].y,Q));h=w[b][M][0][3];2E3<d.length&&(c+="<path d='"+d+"' "+E+" />",h={x:-1,y:-1},d="",1E4<c.length&&($("#qreator_svgbild2 #global #layer_"+b).append(c),c=""),n=g="")}}0<d.length&&
(c+="<path d='"+d+"' "+E+" />");0<c.length&&($("#qreator_svgbild2 #global #layer_"+b).append(c),c="")}}}$("#qreator_svgbild svg").attr("height","100%").attr("width","100%").attr("heightoriginal",F).attr("hoehegesetzt",e).attr("breitegesetzt",G).attr("viewBox","0 0 "+G+"  "+e);$("#qreator_svgbild #qreator_svgbild2").removeAttr("id");$("#qreator_svgbild").html();$(va).html("<div class='"+a+" tshareElement zeichenflaecheKlick' >"+$("#qreator_svgbild").html()+"</div>");$(va).find("."+a).unwrap();$(Aa).html("")};
this.loadSVG=function(a){for(var c=0,e=0;e<I.length;e++)I[e]=1;console.log("Breite: "+$(a).attr("width")+", H\u00f6he: "+$(a).attr("height")+", Originalh\u00f6he: "+$(a).attr("heightoriginal"));e=$(a).attr("heightoriginal");void 0!=e&&($("#rahmen canvas").attr("height",parseInt(e)),F=parseInt(e));e=$(a).attr("breitegesetzt");void 0!=e&&($("#rahmen canvas").attr("width",parseInt(e)),G=parseInt(e));$(a).find("#global").find("g").each(function(){var a=parseInt($(this).attr("id").split("_")[1]);w[a]=
[];bilder[a]=[];c++;"hidden"==$(this).attr("visibility")&&(I[a]=0);$(this).find("image").each(function(){var b={data:$(this).attr("xlink:href"),x:parseInt($(this).attr("x")),y:parseInt($(this).attr("y")),breite:parseInt($(this).attr("width")),hoehe:parseInt($(this).attr("height")),ebene:a,nr:bilder[a].length};bilder[a].push(b)});$(this).find("path").each(function(){for(var b=$(this).attr("stroke"),c=parseInt($(this).attr("stroke-width")),e=$(this).attr("d").trim().split("M"),f=0;f<e.length;f++)if(""!=
e[f]){for(var n=e[f].split("c"),r=n[0].split(" "),k=[],B=0;B<r.length;B++)""!=r[B]&&k.push(r[B]);r=[];B=new t(parseFloat(k[0]),parseFloat(k[1]));r.push(B);for(k=1;k<n.length;k++){var p=n[k].split(" "),l=[];for(B=0;B<p.length;B++)""!=p[B]&&l.push(p[B]);if(6<=l.length)for(p=0;6>p;p+=2)B=new t(parseFloat(l[p])+r[0].x,parseFloat(l[p+1])+r[0].y),r.push(B);w[a].push([r,z.findeRechtecksHuelle(r),0,c,b]);q[a].push(w[a].length);4==r.length&&(B=new t(r[3].x,r[3].y),r=[],r.push(B))}}})});a=[];10>c&&(c=10);for(e=
0;e<c;e++)a[e]=e,null==I[e]&&(I[e]=1);for(e=0;e<I.length;e++);K(a[k],0,c-1,!0);v()};var z={initialisiere:function(a,c){this.ergebnis=[];this.epsilon=1E-11;this.TOLERANZ=1E-6;var e=null;this.fehler=c;this.punkte=[];for(var f=0;f<a.length;f++){var b=a[f];e&&b.x==e.x&&b.y==e.y||(this.punkte.push(b),e=b)}this.fehler=c},findeRechtecksHuelle:function(a){for(var c=a[0].x,e=c,f=a[0].y,b=f,d=1;d<a.length;d++)c>a[d].x?c=a[d].x:e<a[d].x&&(e=a[d].x),f>a[d].y?f=a[d].y:b<a[d].y&&(b=a[d].y);return[c-L,f-L,e+L,b+
L]},findeKonvexeHuelle:function(a){function c(a,b){var c=a.x-b.x;a=a.y-b.y;return c*c+a*a}function e(a,b,d){var e=(b.x-a.x)*(d.y-a.y)-(d.x-a.x)*(b.y-a.y);return 0<e?!0:0>e?!1:c(a,d)>c(a,b)}for(var f=a.length,b=[],d=0,h=1;h!=f;h++)a[h].y<a[d].y&&(d=h);d=a[d];var g=null;do{b.push(d);g=a[0];for(h=1;h!=f;h++)if(d.x===g.x&&d.y===g.y||e(d,g,a[h]))g=a[h];d=g}while(g.x!==b[0].x||g.y!==b[0].y);return b},parametrisiereKurve:function(a,c){for(var e=[0],f=a+1;f<=c;f++)e[f-a]=e[f-a-1]+this.berechneEntfernungIndex(f,
f-1);a=e[e.length-1];for(c=0;c<e.length;c++)e[c]/=a;return e},berechneEntfernungIndex:function(a,c){var e=this.punkte[a].x-this.punkte[c].x;a=this.punkte[a].y-this.punkte[c].y;return Math.sqrt(e*e+a*a)},berechneEntfernung:function(a,c){var e=a.x-c.x;a=a.y-c.y;return Math.sqrt(e*e+a*a)},normiere:function(a){var c=Math.sqrt(a.x*a.x+a.y*a.y);0!==c&&(a.x/=c,a.y/=c);return a},multipliziereSkalar:function(a,c){return a.x*c.x+a.y*c.y},multipliziereMitSkalar:function(a,c){return{x:a.x*c,y:a.y*c}},addiere:function(a,
c){return{x:a.x+c.x,y:a.y+c.y}},subtrahiere:function(a,c){return{x:a.x-c.x,y:a.y-c.y}},approximiere:function(){var a=this.punkte,c=a.length;this.ergebnis=0<c?[[a[0]]]:[];1<c&&(D(2,"Anzahl der Punkte: "+c),this.approximiereKubisch(0,c-1,this.normiere(this.subtrahiere(a[1],a[0])),this.normiere(this.subtrahiere(a[c-2],a[c-1]))));return this.ergebnis},approximiereKubisch:function(a,c,e,f){if(1===c-a){a=this.punkte[a];c=this.punkte[c];var b=this.berechneEntfernung(a,c)/3;this.ergebnis.push([a,this.addiere(a,
this.multipliziereMitSkalar(this.normiere(e),b)),this.addiere(c,this.multipliziereMitSkalar(this.normiere(f),b)),c])}else{for(var d=this.parametrisiereKurve(a,c),h=Math.max(this.fehler,this.fehler*this.fehler),g=0;4>=g;g++){var n=this.findeBezierNaeherung(a,c,d,e,f);[].push(n);var k=this.findeGroesstenFehler(a,c,n,d);if(k.error<this.fehler){this.ergebnis.push(n);return}b=k.index;if(k.error>=h){D(3,"Maximaler Fehler: "+h+", gemessener Fehler: "+k.error);break}d=this.reparametrisiere(a,c,d,n);h=k.error}d=
this.subtrahiere(this.punkte[b-1],this.punkte[b]);h=this.subtrahiere(this.punkte[b],this.punkte[b+1]);d=this.normiere(this.multipliziereMitSkalar(this.addiere(d,h),.5));this.approximiereKubisch(a,b,e,d);this.approximiereKubisch(b,c,this.multipliziereMitSkalar(d,-1),f)}},findeBezierNaeherung:function(a,c,e,f,b){D(3,"findeBezierN\u00e4herung: "+a+" "+c);var d=this.epsilon,h=null,g=null,k=this.punkte[a],r=this.punkte[c],l=[[0,0],[0,0]],q=[0,0];c=c-a+1;for(var p=0;p<c;p++){var t=e[p],u=1-t,v=3*t*u,w=
u*u*u;u*=v;v*=t;var z=t*t*t;t=this.multipliziereMitSkalar(this.normiere(f),u);var C=this.multipliziereMitSkalar(this.normiere(b),v);w=this.subtrahiere(this.subtrahiere(this.punkte[a+p],this.multipliziereMitSkalar(k,w+u)),this.multipliziereMitSkalar(r,v+z));l[0][0]+=this.multipliziereSkalar(t,t);l[0][1]+=this.multipliziereSkalar(t,C);l[1][0]=l[0][1];l[1][1]+=this.multipliziereSkalar(C,C);q[0]+=this.multipliziereSkalar(t,w);q[1]+=this.multipliziereSkalar(C,w)}a=l[0][0]*l[1][1]-l[1][0]*l[0][1];if(Math.abs(a)>
d){var A=l[0][0]*q[1]-l[1][0]*q[0];q=(q[0]*l[1][1]-q[1]*l[0][1])/a;A/=a}else a=l[0][0]+l[0][1],l=l[1][0]+l[1][1],q=Math.abs(a)>d?A=q[0]/a:Math.abs(l)>d?A=q[1]/l:A=0;l=this.berechneEntfernung(k,r);d*=l;q<d||A<d?q=A=l/3:(d=this.subtrahiere(r,k),h=this.multipliziereMitSkalar(this.normiere(f),q),g=this.multipliziereMitSkalar(this.normiere(b),A),this.multipliziereSkalar(h,d)-this.multipliziereSkalar(g,d)>l*l&&(q=A=l/3,h=g=null));f=this.multipliziereMitSkalar(this.normiere(f),q);b=this.multipliziereMitSkalar(this.normiere(b),
A);null!=h&&(f=h);null!=g&&(b=g);return[k,this.addiere(k,f),this.addiere(r,b),r]},evaluiere:function(a,c,e){c=c.slice();for(var f=1;f<=a;f++)for(var b=0;b<=a-f;b++)c[b]=this.addiere(this.multipliziereMitSkalar(c[b],1-e),this.multipliziereMitSkalar(c[b+1],e));return c[0]},teile:function(a,c){for(var e=a.slice(),f=[],b=1;3>=b;b++)for(var d=0;d<=3-b;d++)e[d]=this.addiere(this.multipliziereMitSkalar(e[d],1-c),this.multipliziereMitSkalar(e[d+1],c)),f.push(e[d]);return[[a[0],f[0],f[3],f[5]],[f[5],f[4],
f[2],a[3]]]},zerlege:function(a,c,e){a=this.teile(a,c)[1];return this.teile(a,(e-c)/(1-c))[0]},findeGroesstenFehler:function(a,c,e,f){for(var b=Math.floor((c-a+1)/2),d=0,h=a+1;h<c;h++){var g=this.evaluiere(3,e,f[h-a]);g=this.subtrahiere(g,this.punkte[h]);g=g.x*g.x+g.y*g.y;g>=d&&(d=g,b=h)}return{error:d,index:b}},reparametrisiere:function(a,c,e,f){for(var b=a;b<=c;b++)e[b-a]=this.findeNullstelle(f,this.punkte[b],e[b-a]);return e},findeNullstelle:function(a,c,e){for(var f=[],b=[],d=0;2>=d;d++)f[d]=
this.multipliziereMitSkalar(this.subtrahiere(a[d+1],a[d]),3);for(d=0;1>=d;d++)b[d]=this.multipliziereMitSkalar(this.subtrahiere(f[d+1],f[d]),2);a=this.evaluiere(3,a,e);f=this.evaluiere(2,f,e);b=this.evaluiere(1,b,e);c=this.subtrahiere(a,c);b=this.multipliziereSkalar(f,f)+this.multipliziereSkalar(c,b);return Math.abs(b)<this.TOLERANZ?e:e-this.multipliziereSkalar(c,f)/b}}};
