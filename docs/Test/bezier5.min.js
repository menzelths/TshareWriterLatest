...
nr:bilder[l[k]].length,data:b,breite:f,hoehe:c,x:a,y:d,behalten:e};for(d=0;d<l.length;d++)0<bilder[d].length&&!1===bilder[d][bilder[d].length-1].behalten&&bilder[d].pop();bilder[l[k]].push(a);J(k,0,k,!0)};this.insertImgAsSVG=function(b,a,d,f,c){$("#content").append("<div id='qreator_svgbild'></div>");$("#qreator_svgbild").html("<svg  width='100%' height='100%' viewBox='0 0 "+a+" "+a/b.width*b.height+"' hoehegesetzt='"+a/b.width*b.height+"' breitegesetzt='"+a+"' heightoriginal='"+a/b.width*b.height+
"' id='qreator_svgbild2' class='qreator_svg'><g fill='none' stroke-linecap='round' id='global'></g>");$("#qreator_svgbild2 #global").append("<g id='layer_2'></g>");$("#qreator_svgbild2 #global #layer_2").append(document.createElementNS("http://www.w3.org/2000/svg","image"));$("#qreator_svgbild2 #global #layer_2 image").last().attr("bildnr","0").attr("x","0").attr("y","0").attr("width",""+a).attr("height",""+a/b.width*b.height).attr("xlink:href",""+b.src).attr("hoeheoriginal",""+a/b.width*b.height);
$("#"+f).before("<div class='zeichenflaeche tshareElement zeichenflaecheKlick' >"+$("#qreator_svgbild").html()+"</div>"+c);$("#qreator_svgbild2").removeAttr("id");$("#qreator_svgbild").html("");$("#qreator_svgbild").remove()};this.showSVG=function(b){var a="",d=0;$("#qreator_svgbild").html("<svg  width='"+E+"' height='"+F+"' id='qreator_svgbild2' class='qreator_svg'><g fill='none' stroke-linecap='round' id='global'></g>");for(var f=0;f<l.length;f++){var c=l[f];if(null!=z[c]&&0<z[c].length||null!=
bilder[c]&&0<bilder[c].length){var e="";0==H[f]&&(e="visibility='hidden'");$("#qreator_svgbild2 #global").append("<g id='layer_"+c+"' "+e+"></g>");if(null!=bilder[c])for(e=0;e<bilder[c].length;e++){var h=bilder[c][e];$("#qreator_svgbild2 #global #layer_"+c).append(document.createElementNS("http://www.w3.org/2000/svg","image"));$("#qreator_svgbild2 #global #layer_"+c+" image").last().attr("bildnr",e).attr("x",""+h.x).attr("y",""+h.y).attr("width",""+h.breite).attr("height",""+h.hoehe).attr("xlink:href",
""+h.data);h.y+h.hoehe>d&&(d=h.y+h.hoehe)}if(null!=z[c]&&0<z[c].length){for(var e="",h=z[c][0][0][3],g="",n="",u="",k="",t=0;t<p[c].length;t++){var q=p[c][t];if(0<q){M=q-1;var q=z[c][M][0],v=z[c][M][4],w=z[c][M][3],C=z[c][M][1][3];C>d&&0<c&&(d=C);if(v!=g||w!=n)u=" stroke='"+v+"'",g=v,u+=" stroke-width='"+w+"'",n=w;0<u.length&&(0<e.length&&(a+="<path d='"+e+"' "+k+" />",h={x:-1,y:-1},e=""),k=u,u="");e=0<M&&q[0].x===h.x&&q[0].y===h.y?e+(" c "+r(q[1].x-q[0].x,Q)+" "+r(q[1].y-q[0].y,Q)+" "+r(q[2].x-q[0].x,
Q)+" "+r(q[2].y-q[0].y,Q)+" "+r(q[3].x-q[0].x,Q)+" "+r(q[3].y-q[0].y,Q)):e+(" M "+r(q[0].x,Q)+" "+r(q[0].y,Q)+" c "+r(q[1].x-q[0].x,Q)+" "+r(q[1].y-q[0].y,Q)+" "+r(q[2].x-q[0].x,Q)+" "+r(q[2].y-q[0].y,Q)+" "+r(q[3].x-q[0].x,Q)+" "+r(q[3].y-q[0].y,Q));h=z[c][M][0][3];2E3<e.length&&(a+="<path d='"+e+"' "+k+" />",h={x:-1,y:-1},e="",1E4<a.length&&($("#qreator_svgbild2 #global #layer_"+c).append(a),a=""),n=g="")}}0<e.length&&(a+="<path d='"+e+"' "+k+" />");0<a.length&&($("#qreator_svgbild2 #global #layer_"+
c).append(a),a="")}}}$("#qreator_svgbild svg").attr("height","100%").attr("width","100%").attr("heightoriginal",F).attr("hoehegesetzt",d).attr("breitegesetzt",E).attr("viewBox","0 0 "+E+"  "+d);$("#qreator_svgbild #qreator_svgbild2").removeAttr("id");$("#qreator_svgbild").html();$(qa).html("<div class='"+b+" tshareElement zeichenflaecheKlick' >"+$("#qreator_svgbild").html()+"</div>");$(qa).find("."+b).unwrap();$(va).html("")};this.loadSVG=function(b){for(var a=0,d=0;d<H.length;d++)H[d]=1;console.log("Breite: "+
$(b).attr("width")+", H\u00f6he: "+$(b).attr("height")+", Originalh\u00f6he: "+$(b).attr("heightoriginal"));d=$(b).attr("heightoriginal");void 0!=d&&($("#rahmen canvas").attr("height",parseInt(d)),F=parseInt(d));d=$(b).attr("breitegesetzt");void 0!=d&&($("#rahmen canvas").attr("width",parseInt(d)),E=parseInt(d));$(b).find("#global").find("g").each(function(){var b=parseInt($(this).attr("id").split("_")[1]);z[b]=[];bilder[b]=[];a++;"hidden"==$(this).attr("visibility")&&(H[b]=0);$(this).find("image").each(function(){var a=
{data:$(this).attr("xlink:href"),x:parseInt($(this).attr("x")),y:parseInt($(this).attr("y")),breite:parseInt($(this).attr("width")),hoehe:parseInt($(this).attr("height")),ebene:b,nr:bilder[b].length};bilder[b].push(a)});$(this).find("path").each(function(){for(var a=$(this).attr("stroke"),d=parseInt($(this).attr("stroke-width")),f=$(this).attr("d").trim().split("M"),g=0;g<f.length;g++)if(""!=f[g]){for(var n=f[g].split("c"),u=n[0].split(" "),k=[],t=0;t<u.length;t++)""!=u[t]&&k.push(u[t]);u=[];t=new w(parseFloat(k[0]),
parseFloat(k[1]));u.push(t);for(k=1;k<n.length;k++){for(var q=n[k].split(" "),l=[],t=0;t<q.length;t++)""!=q[t]&&l.push(q[t]);if(6<=l.length)for(q=0;6>q;q+=2)t=new w(parseFloat(l[q])+u[0].x,parseFloat(l[q+1])+u[0].y),u.push(t);z[b].push([u,B.findeRechtecksHuelle(u),0,d,a]);p[b].push(z[b].length);4==u.length&&(t=new w(u[3].x,u[3].y),u=[],u.push(t))}}})});b=[];10>a&&(a=10);for(d=0;d<a;d++)b[d]=d,null==H[d]&&(H[d]=1);for(d=0;d<H.length;d++);J(b[k],0,a-1,!0);v()};var B={initialisiere:function(b,a){this.ergebnis=
[];this.epsilon=1E-11;this.TOLERANZ=1E-6;var d=null;this.fehler=a;this.punkte=[];for(var f=0;f<b.length;f++){var c=b[f];d&&c.x==d.x&&c.y==d.y||(this.punkte.push(c),d=c)}this.fehler=a},findeRechtecksHuelle:function(b){for(var a=b[0].x,d=a,f=b[0].y,c=f,e=1;e<b.length;e++)a>b[e].x?a=b[e].x:d<b[e].x&&(d=b[e].x),f>b[e].y?f=b[e].y:c<b[e].y&&(c=b[e].y);return[a-K,f-K,d+K,c+K]},findeKonvexeHuelle:function(b){function a(a,b){var c=a.x-b.x;a=a.y-b.y;return c*c+a*a}function d(b,c,d){var e=(c.x-b.x)*(d.y-b.y)-
(d.x-b.x)*(c.y-b.y);return 0<e?!0:0>e?!1:a(b,d)>a(b,c)}for(var f=b.length,c=[],e=0,h=1;h!=f;h++)b[h].y<b[e].y&&(e=h);var e=b[e],g=null;do{c.push(e);g=b[0];for(h=1;h!=f;h++)if(e.x===g.x&&e.y===g.y||d(e,g,b[h]))g=b[h];e=g}while(g.x!==c[0].x||g.y!==c[0].y);return c},parametrisiereKurve:function(b,a){for(var d=[0],f=b+1;f<=a;f++)d[f-b]=d[f-b-1]+this.berechneEntfernungIndex(f,f-1);b=d[d.length-1];for(a=0;a<d.length;a++)d[a]/=b;return d},berechneEntfernungIndex:function(b,a){var d=this.punkte[b].x-this.punkte[a].x;
b=this.punkte[b].y-this.punkte[a].y;return Math.sqrt(d*d+b*b)},berechneEntfernung:function(b,a){var d=b.x-a.x;b=b.y-a.y;return Math.sqrt(d*d+b*b)},normiere:function(b){var a=Math.sqrt(b.x*b.x+b.y*b.y);0!==a&&(b.x/=a,b.y/=a);return b},multipliziereSkalar:function(b,a){return b.x*a.x+b.y*a.y},multipliziereMitSkalar:function(b,a){return{x:b.x*a,y:b.y*a}},addiere:function(b,a){return{x:b.x+a.x,y:b.y+a.y}},subtrahiere:function(b,a){return{x:b.x-a.x,y:b.y-a.y}},approximiere:function(){var b=this.punkte,
a=b.length;this.ergebnis=0<a?[[b[0]]]:[];1<a&&(C(2,"Anzahl der Punkte: "+a),this.approximiereKubisch(0,a-1,this.normiere(this.subtrahiere(b[1],b[0])),this.normiere(this.subtrahiere(b[a-2],b[a-1]))));return this.ergebnis},approximiereKubisch:function(b,a,d,f){if(1===a-b){b=this.punkte[b];a=this.punkte[a];var c=this.berechneEntfernung(b,a)/3;this.ergebnis.push([b,this.addiere(b,this.multipliziereMitSkalar(this.normiere(d),c)),this.addiere(a,this.multipliziereMitSkalar(this.normiere(f),c)),a])}else{for(var e=
this.parametrisiereKurve(b,a),h=Math.max(this.fehler,this.fehler*this.fehler),g=0;4>=g;g++){var n=this.findeBezierNaeherung(b,a,e,d,f);[].push(n);var k=this.findeGroesstenFehler(b,a,n,e);if(k.error<this.fehler){this.ergebnis.push(n);return}c=k.index;if(k.error>=h){C(3,"Maximaler Fehler: "+h+", gemessener Fehler: "+k.error);break}e=this.reparametrisiere(b,a,e,n);h=k.error}e=this.subtrahiere(this.punkte[c-1],this.punkte[c]);h=this.subtrahiere(this.punkte[c],this.punkte[c+1]);e=this.normiere(this.multipliziereMitSkalar(this.addiere(e,
h),.5));this.approximiereKubisch(b,c,d,e);this.approximiereKubisch(c,a,this.multipliziereMitSkalar(e,-1),f)}},findeBezierNaeherung:function(b,a,d,f,c){C(3,"findeBezierN\u00e4herung: "+b+" "+a);var e=this.epsilon,h=null,g=null,n=this.punkte[b],k=this.punkte[a],l=[[0,0],[0,0]],t=[0,0];a=a-b+1;for(var q=0;q<a;q++){var p=d[q],r=1-p,v=3*p*r,w=r*r*r,r=v*r,v=v*p,z=p*p*p,p=this.multipliziereMitSkalar(this.normiere(f),r),B=this.multipliziereMitSkalar(this.normiere(c),v),w=this.subtrahiere(this.subtrahiere(this.punkte[b+
q],this.multipliziereMitSkalar(n,w+r)),this.multipliziereMitSkalar(k,v+z));l[0][0]+=this.multipliziereSkalar(p,p);l[0][1]+=this.multipliziereSkalar(p,B);l[1][0]=l[0][1];l[1][1]+=this.multipliziereSkalar(B,B);t[0]+=this.multipliziereSkalar(p,w);t[1]+=this.multipliziereSkalar(B,w)}b=l[0][0]*l[1][1]-l[1][0]*l[0][1];if(Math.abs(b)>e){var A=l[0][0]*t[1]-l[1][0]*t[0];t=(t[0]*l[1][1]-t[1]*l[0][1])/b;A/=b}else b=l[0][0]+l[0][1],l=l[1][0]+l[1][1],t=Math.abs(b)>e?A=t[0]/b:Math.abs(l)>e?A=t[1]/l:A=0;l=this.berechneEntfernung(n,
k);e*=l;t<e||A<e?t=A=l/3:(e=this.subtrahiere(k,n),h=this.multipliziereMitSkalar(this.normiere(f),t),g=this.multipliziereMitSkalar(this.normiere(c),A),this.multipliziereSkalar(h,e)-this.multipliziereSkalar(g,e)>l*l&&(t=A=l/3,h=g=null));f=this.multipliziereMitSkalar(this.normiere(f),t);c=this.multipliziereMitSkalar(this.normiere(c),A);null!=h&&(f=h);null!=g&&(c=g);return[n,this.addiere(n,f),this.addiere(k,c),k]},evaluiere:function(b,a,d){a=a.slice();for(var f=1;f<=b;f++)for(var c=0;c<=b-f;c++)a[c]=
this.addiere(this.multipliziereMitSkalar(a[c],1-d),this.multipliziereMitSkalar(a[c+1],d));return a[0]},teile:function(b,a){for(var d=b.slice(),f=[],c=1;3>=c;c++)for(var e=0;e<=3-c;e++)d[e]=this.addiere(this.multipliziereMitSkalar(d[e],1-a),this.multipliziereMitSkalar(d[e+1],a)),f.push(d[e]);return[[b[0],f[0],f[3],f[5]],[f[5],f[4],f[2],b[3]]]},zerlege:function(b,a,d){b=this.teile(b,a)[1];return this.teile(b,(d-a)/(1-a))[0]},findeGroesstenFehler:function(b,a,d,f){for(var c=Math.floor((a-b+1)/2),e=0,
h=b+1;h<a;h++){var g=this.evaluiere(3,d,f[h-b]),g=this.subtrahiere(g,this.punkte[h]),g=g.x*g.x+g.y*g.y;g>=e&&(e=g,c=h)}return{error:e,index:c}},reparametrisiere:function(b,a,d,f){for(var c=b;c<=a;c++)d[c-b]=this.findeNullstelle(f,this.punkte[c],d[c-b]);return d},findeNullstelle:function(b,a,d){for(var f=[],c=[],e=0;2>=e;e++)f[e]=this.multipliziereMitSkalar(this.subtrahiere(b[e+1],b[e]),3);for(e=0;1>=e;e++)c[e]=this.multipliziereMitSkalar(this.subtrahiere(f[e+1],f[e]),2);b=this.evaluiere(3,b,d);f=
this.evaluiere(2,f,d);c=this.evaluiere(1,c,d);a=this.subtrahiere(b,a);c=this.multipliziereSkalar(f,f)+this.multipliziereSkalar(a,c);return Math.abs(c)<this.TOLERANZ?d:d-this.multipliziereSkalar(a,f)/c}}};
